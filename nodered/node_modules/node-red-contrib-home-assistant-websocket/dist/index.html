...
<script type="text/javascript">!function(){"use strict";const e="0.0.0",t="__ALL_TAGS__";var n,i,a,o,s,r,l,u;!function(e){e.Is="is",e.IsNot="is_not",e.IsLessThan="lt",e.IsLessThanOrEqual="lte",e.IsGreaterThan="gt",e.IsGreaterThanOrEqual="gte",e.Includes="includes",e.DoesNotInclude="does_not_include",e.Contains="cont",e.StartsWith="starts_with",e.InGroup="in_group",e.JSONata="jsonata"}(n||(n={})),function(e){e.Boolean="boolean",e.Float="float",e.Integer="integer",e.PositiveTimePeriod="positive_time_period_dict",e.Select="select",e.String="string"}(i||(i={})),function(e){e.BinarySensor="binary_sensor",e.Button="button",e.Number="number",e.Select="select",e.Sensor="sensor",e.Switch="switch",e.Text="text",e.Time="time"}(a||(a={})),function(e){e.Exact="exact",e.List="list",e.Regex="regex",e.Substring="substring"}(o||(o={})),function(e){e.API="ha-api",e.CallSevice="api-call-service",e.CurrentState="api-current-state",e.Device="ha-device",e.Entity="ha-entity",e.EventsAll="server-events",e.EventsCalendar="ha-events-calendar",e.EventsState="server-state-changed",e.FireEvent="ha-fire-event",e.GetEntities="ha-get-entities",e.GetHistory="api-get-history",e.PollState="poll-state",e.RenderTemplate="api-render-template",e.Select="ha-select",e.Sentence="ha-sentence",e.TriggerState="trigger-state",e.Tag="ha-tag",e.Time="ha-time",e.WaitUntil="ha-wait-until",e.Webhook="ha-webhook",e.Zone="ha-zone",e.Server="server",e.DeviceConfig="ha-device-config",e.EntityConfig="ha-entity-config",e.BinarySensor="ha-binary-sensor",e.Button="ha-button",e.Number="ha-number",e.Sensor="ha-sensor",e.Switch="ha-switch",e.Text="ha-text",e.TimeEntity="ha-time-entity",e.UpdateConfig="ha-update-config"}(s||(s={})),function(e){e.Get="get",e.Set="set",e.Listen="listen"}(r||(r={})),function(e){e.Message="msg",e.Flow="flow",e.Global="global",e.Boolean="bool",e.JSON="json",e.Date="date",e.JSONata="jsonata",e.Number="num",e.String="str",e.None="none",e.Config="config",e.Data="data",e.Entity="entity",e.EntityState="entityState",e.EventData="eventData",e.Headers="headers",e.Params="params",e.TriggerId="triggerId",e.PrevEntity="prevEntity",e.Results="results",e.Regex="re",e.Value="value",e.PreviousValue="previousValue",e.CalendarItem="calendarItem",e.DeviceId="deviceId"}(l||(l={})),function(e){e.Milliseconds="milliseconds",e.Seconds="seconds",e.Minutes="minutes",e.Hours="hours",e.Days="days"}(u||(u={}));const p=(e,t)=>{let n=RED._(`node-red-contrib-home-assistant-websocket/all:${e}`,t);return-1!==n.indexOf("\n")&&(n=n.split("\n").map((e=>`<p>${e}</p>`)).join("")),n};function d(e,t){if(e===t)return!0;if("object"!=typeof e||"object"!=typeof t||null==e||null==t)return!1;const n=Object.keys(e),i=Object.keys(t);if(n.length<i.length)return!1;for(const a of i){if(!n.includes(a))return!1;if(!d(e[a],t[a]))return!1}return!0}function c(e,t){return e.split(".").reduce(((e,t)=>e[t]),t)}function v(e){return e&&(e instanceof jQuery||e.constructor.prototype.jquery)}const y=e=>{const t=v(e)?e:$(e);t.on("select2:unselecting",(()=>{t.on("select2:opening",(e=>{e.preventDefault(),t.off("select2:opening")}))}))},g={},h={},m={},f={},b={};function T(e){return e.split("/")[2]}function _(e,t){const n=e.label,i=t.label;return n===i?0:n.localeCompare(i)}function S(e){var t;return null!==(t=g[e])&&void 0!==t?t:[]}function E(e){var t;return null!==(t=h[e])&&void 0!==t?t:[]}function w(e,t,n="."){return Object.keys(e).reduce(((i,a)=>{const o=e[a],s=[t,a].filter(Boolean).join(n);return["object"==typeof o,null!==o,!(o instanceof Date),!(o instanceof RegExp),!(Array.isArray(o)&&0===o.length)].every(Boolean)?Object.assign(Object.assign({},i),w(o,s,n)):Object.assign(Object.assign({},i),{[s]:o})}),{})}function D(e){function t(e){let t,n=1;return"string"==typeof e&&e.startsWith("-")?(n=-1,t=e.substring(1)):t=e,function(e,i){const a=e[t],o=i[t];return("string"==typeof a&&"string"==typeof o?a.localeCompare(o):a<o?-1:a>o?1:0)*n}}return function(n,i){let a=0,o=0;const s=null==e?void 0:e.length;for(;0===o&&a<s;)o=t(e[a])(n,i),a++;return o}}let I;const x={show:e=>{RED.view.state(RED.state.EDITING);const t={title:p("home-assistant.label.filter_results_title"),width:"inherit",buttons:[{id:"node-dialog-cancel",text:p("home-assistant.label.cancel"),click:()=>{RED.tray.close()}},{id:"node-dialog-ok",text:p("home-assistant.label.done"),class:"primary",click:()=>{e.complete(I),RED.tray.close()}}],open:t=>{const n=t.find(".red-ui-tray-body");RED.editor.buildEditForm(n,"dialog-form","ha_entity_filter","node-red-contrib-home-assistant-websocket/all"),t.i18n(),$("#dialog-form").addClass("home-assistant"),n.find("select").val(e.filterType),n.find("input").val(e.filter).on("input",(t=>{const i=((e,t,n)=>{let i=[];if("regex"===n)try{const n=new RegExp(t);i=e.filter((e=>n.test(e.entity_id)))}catch(e){i=[]}else"substring"===n&&(i=e.filter((e=>e.entity_id.includes(t))));return i.sort(D(["entity_id"]))})(e.entities,t.target.value,e.filterType);I=t.target.value,n.find("ul").html((e=>e.length?e.map((e=>`<li>${e.entity_id}</li>`)).join(""):`<li>${p("home-assistant.label.no_matches_found")}</li>`)(i))})).trigger("input")}};RED.tray.show(t)}};let O;const C={};function j(){let e=$("#node-input-server").val();if(function(){const e=[s.BinarySensor,s.Button,s.Number,s.Select,s.Sensor,s.Switch,s.Text,s.TimeEntity];return"type"in O&&(null==O?void 0:O.type)&&e.includes(O.type)}()){const t=RED.nodes.node($("#node-input-entityConfig").val());e=null==t?void 0:t.server}if(e&&"_ADD_"!==e)return e}function k(){const t=j();return t&&C[t]?C[t]:e}function P(){return k()!==e}function R(e){return"_ADD_"===$(`#node-input-${e}`).val()}function A(e){O=e;const t="type"in O&&O.type;!function(){const e="type"in O&&O.type;switch(e){case s.BinarySensor:case s.Button:case s.Number:case s.Select:case s.Sensor:case s.Switch:case s.Text:case s.TimeEntity:R("entityConfig")||B(e);break;case s.Device:case s.Sentence:case s.Webhook:R("server")||B(e);break;case s.EventsAll:case s.EventsCalendar:case s.EventsState:case s.PollState:case s.Tag:case s.Time:case s.TriggerState:case s.Zone:break;default:!function(){const e=$("<div />",{id:"exposeToHa",class:"form-row checkbox-option"+("type"in O&&"trigger-state"===O.type?"-left":"")});$("<input />",{type:"checkbox",id:"node-input-exposeToHomeAssistant",checked:O.exposeToHomeAssistant}).on("change",(function(){$("#haConfigRow").toggle(!0===$("#node-input-exposeToHomeAssistant").is(":checked"))})).appendTo(e),$("<label />",{for:"node-input-exposeToHomeAssistant",text:"Expose to Home Assistant"}).appendTo(e);const t=$("<div />",{class:"form-row",id:"haConfigRow"}),n=$("<ol />",{id:"haConfig"}).appendTo(t),i=O.haConfig||[{property:"name",value:""},{property:"icon",value:""}];n.editableList({addButton:!1,header:$("<div>Home Assistant Config (optional)</div>"),addItem:function(e,t,n){const i=$("<div />").appendTo(e),a=$("<label>").appendTo(i);$("<span>").text(n.property.replace(/_/g," ")).appendTo(a),$("<input />",{type:"hidden",name:"property",value:n.property}).appendTo(a),$("<input />",{type:"text",name:"value",value:n.value}).attr("autocomplete","disable").appendTo(a)}}).editableList("addItems",i),$("#dialog-form").append(e).append(t),$("#node-input-exposeToHomeAssistant").trigger("change")}()}}(),$("#node-input-server, #node-input-entityConfig").on("change",(()=>{switch(t){case s.BinarySensor:case s.Button:case s.Number:case s.Select:case s.Sensor:case s.Switch:case s.Text:case s.TimeEntity:R("entityConfig")||B(t);break;case s.Device:B(t);break;case s.Sentence:case s.Webhook:R("server")||B(t);break;case s.EventsAll:case s.EventsCalendar:case s.EventsState:case s.PollState:case s.Tag:case s.TriggerState:case s.Zone:case s.Time:default:!function(){$("#node-input-exposeAsEntityConfig").closest("div.form-row").toggle(P()),P()||$("#node-input-exposeToHomeAssistant").prop("checked",!1).trigger("change");$("#exposeToHa").toggle(P())}()}}))}const L={[s.BinarySensor]:"1.1.0",[s.Button]:"1.0.4",[s.Device]:"3.0.0",[s.Number]:"1.3.0",[s.Select]:"1.4.0",[s.Sentence]:"2.2.0",[s.Sensor]:"1.1.0",[s.Switch]:"1.1.0",[s.Tag]:"0.5.0",[s.Text]:"1.3.0",[s.TimeEntity]:"2.1.0",[s.Webhook]:"1.6.0"};function B(e){const t=L[e],n=void 0===t||(i=t,a=k(),(i=i.split(".").map((e=>e.padStart(5))).join("."))<=a.split(".").map((e=>e.padStart(5))).join("."));var i,a;const o=P()&&n;if(!$("#integrationAlert").length){const e=`\n            <div id="integrationAlert" class="ui-state-error ha-alert-box">\n                This node requires <a href="https://github.com/zachowj/hass-node-red" target="_blank">Node-RED custom integration ${n?"":`version ${t}+`} <i class="fa fa-external-link external-link"></i></a> to be installed in Home Assistant for it to function.\n            </div>`;$("#dialog-form").prepend(e)}$("#integrationAlert").toggle(!o)}var N=e=>{var t;try{null===(t=null===navigator||void 0===navigator?void 0:navigator.clipboard)||void 0===t||t.writeText(e)}catch(t){const n=document.createElement("textarea");n.textContent=e;const i=document.getElementsByTagName("body")[0];i.appendChild(n),n.select(),document.execCommand("copy"),i.removeChild(n)}};const H=Handlebars.compile($("#handlebars-sidebar-list").html()),V=Handlebars.compile($("#handlebars-sidebar-filter").html());let M,F,q;function G(){[{type:s.Server,section:M},{type:s.EntityConfig,section:F},{type:s.DeviceConfig,section:q}].forEach((({type:e,section:t})=>{t.content.empty();const n=function(e){const t=[],n=new Set;return RED.nodes.eachConfig((function(i){return i.type===e&&(i.entityType&&n.add(i.entityType),t.push({name:i.name||i.id,id:i.id,count:i.users.length,type:i.entityType})),!0})),{list:t.sort(((e,t)=>e.name.localeCompare(t.name))),types:[...n].sort()}}(e);n.types.length>1&&$(V(n)).on("change","select",(function(){const e=$(this).val();t.content.find(".ha-list-row").each((function(){const t=$(this);"__all__"===e||t.data("type")===e?t.show():t.hide()}))})).appendTo(t.content),$(H(n)).on("click",".ha-list-row-name",(function(t){t.stopPropagation(),RED.editor.editConfig("",e,$(this).parent().data("id"),"")})).on("click",".ha-list-row-count",(function(e){e.stopPropagation(),RED.search.show($(this).parent().data("id"))})).appendTo(t.content)}))}var W=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>{const t=Object.assign(Object.assign({},e),{version:1,outputProperties:[],location:void 0,locationType:void 0});return"none"!==e.locationType&&(t.outputProperties=[{property:e.location,propertyType:e.locationType,value:"",valueType:"results"}]),t}}],z=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})}],U=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>{const t=Object.assign(Object.assign({},e),{version:1});try{const n=JSON.parse(e.data);n.entity_id?(t.entityId=n.entity_id,delete n.entity_id,t.data=Object.keys(n).length?JSON.stringify(n):""):t.entityId=""}catch(e){}return t}},{version:2,up:e=>{const t=Object.assign(Object.assign({},e),{version:2,outputProperties:[]});return"none"!==e.output_location_type&&(t.outputProperties=[{property:e.output_location,propertyType:e.output_location_type,value:"",valueType:"data"}]),t}},{version:3,up:e=>Object.assign(Object.assign({},e),{version:3,queue:"none"})},{version:4,up:e=>Object.assign(Object.assign({},e),{version:4,target:{entityId:(null==e?void 0:e.entityId)?e.entityId.split(",").map((e=>e.trim())):[],areaId:[],deviceId:[]},domain:e.service_domain,mergeContext:e.mergecontext,entityId:void 0,service_domain:void 0,mergecontext:void 0})},{version:5,up:e=>{var t,n,i;return Object.assign(Object.assign({},e),{version:5,areaId:null===(t=e.target)||void 0===t?void 0:t.areaId,deviceId:null===(n=e.target)||void 0===n?void 0:n.deviceId,entityId:null===(i=e.target)||void 0===i?void 0:i.entityId,target:void 0})}}],J=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,ha_boolean:e.ha_boolean||"y|yes|true|on|home|open",rejectUnauthorizedCerts:void 0===e.rejectUnauthorizedCerts||e.rejectUnauthorizedCerts,connectionDelay:void 0===e.connectionDelay||e.connectionDelay,cacheJson:void 0===e.cacheJson||e.cacheJson})},{version:2,up:e=>Object.assign(Object.assign({},e),{version:2,heartbeat:!1,heartbeatInterval:30})},{version:3,up:e=>Object.assign(Object.assign({},e),{version:3,areaSelector:"friendlyName",deviceSelector:"friendlyName",entitySelector:"friendlyName"})},{version:4,up:e=>Object.assign(Object.assign({},e),{version:4,statusSeparator:"at: ",statusYear:"hidden",statusMonth:"short",statusDay:"numeric",statusHourCycle:"h23",statusTimeFormat:"h:m"})},{version:5,up:e=>Object.assign(Object.assign({},e),{version:5,enableGlobalContextStore:!0})}],K=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,blockInputOverrides:!1,entity_location:"data",halt_if_compare:"is",override_payload:!1===e.override_payload?"none":"msg",override_data:!1===e.override_data?"none":"msg",state_location:"payload",state_type:"str"})},{version:2,up:e=>{const t=Object.assign(Object.assign({},e),{version:2,outputProperties:[],state_location:void 0,override_payload:void 0,entity_location:void 0,override_data:void 0,override_topic:void 0});return"none"!==e.override_payload&&t.outputProperties.push({property:e.state_location,propertyType:e.override_payload,value:"",valueType:"entityState"}),"none"!==e.override_data&&t.outputProperties.push({property:e.entity_location,propertyType:e.override_data,value:"",valueType:"entity"}),!0===e.override_topic&&t.outputProperties.push({property:"topic",propertyType:"msg",value:"",valueType:"triggerId"}),t}},{version:3,up:e=>Object.assign(Object.assign({},e),{version:3,for:0,forType:"num",forUnits:"minutes"})}],Z=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>{const t=Object.assign(Object.assign({},e),{version:1,exposeAsEntityConfig:""});return t.exposeToHomeAssistant=void 0,t.haConfig=void 0,t}}],X=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})}],Y=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,inputOverride:"allow"})},{version:2,up:e=>{const t=Object.assign(Object.assign({},e),{version:2});return t.config.push({property:"state_class",value:""}),t.config.push({property:"last_reset",value:""}),t}},{version:3,up:e=>Object.assign(Object.assign({},e),{version:3})}],Q=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1})},{version:2,up:e=>Object.assign(Object.assign({},e),{version:2})},{version:3,up:e=>Object.assign(Object.assign({},e),{version:3})},{version:4,up:e=>Object.assign(Object.assign({},e),{version:4})},{version:5,up:e=>Object.assign(Object.assign({},e),{version:5})},{version:6,up:e=>Object.assign(Object.assign({},e),{version:6})}],ee=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0,waitForRunning:void 0===e.waitForRunning||e.waitForRunning})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,outputProperties:[{property:"payload",propertyType:"msg",value:"",valueType:"eventData"},{property:"topic",propertyType:"msg",value:'$outputData("eventData").event_type',valueType:"jsonata"},{property:"event_type",propertyType:"msg",value:'$outputData("eventData").event_type',valueType:"jsonata"}]})},{version:2,up:e=>Object.assign(Object.assign({},e),{version:2,eventType:e.event_type,event_type:void 0})},{version:3,up:e=>{const t=Object.assign(Object.assign({},e),{version:3,exposeAsEntityConfig:""});return t.exposeToHomeAssistant=void 0,t.haConfig=void 0,t}}],te=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})}],ne=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0,state_type:void 0!==e.state_type?e.state_type:"str",halt_if_type:void 0!==e.halt_if_type?e.halt_if_type:"str",halt_if_compare:void 0!==e.halt_if_compare?e.halt_if_compare:"is"})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,ignorePrevStateNull:!1,ignorePrevStateUnknown:!1,ignorePrevStateUnavailable:!1,ignoreCurrentStateUnknown:!1,ignoreCurrentStateUnavailable:!1})},{version:2,up:e=>Object.assign(Object.assign({},e),{version:2,for:void 0!==e.for?e.for:"0",forType:e.forType||"num",forUnits:e.forUnits||"minutes"})},{version:3,up:e=>Object.assign(Object.assign({},e),{version:3,outputProperties:[{property:"payload",propertyType:"msg",value:"",valueType:"entityState"},{property:"data",propertyType:"msg",value:"",valueType:"eventData"},{property:"topic",propertyType:"msg",value:"",valueType:"triggerId"}]})},{version:4,up:e=>{var t;const n=Object.assign(Object.assign({},e),{version:4});return"substring"===e.entityidfiltertype&&(null===(t=e.entityidfilter)||void 0===t?void 0:t.includes(","))&&(n.entityidfiltertype="list",n.entityidfilter=e.entityidfilter.split(",").map((e=>e.trim())).filter((e=>e.length>0))),n}},{version:5,up:e=>{const t=Object.assign(Object.assign({},e),{version:5,entityId:e.entityidfilter,entityIdType:e.entityidfiltertype,ifState:e.haltifstate,ifStateType:e.halt_if_type,ifStateOperator:e.halt_if_compare,outputInitially:e.outputinitially,stateType:e.state_type,outputOnlyOnStateChange:e.output_only_on_state_change,exposeAsEntityConfig:""});return t.entityidfilter=void 0,t.entityidfiltertype=void 0,t.haltifstate=void 0,t.halt_if_type=void 0,t.halt_if_compare=void 0,t.outputinitially=void 0,t.state_type=void 0,t.output_only_on_state_change=void 0,t.exposeToHomeAssistant=void 0,t.haConfig=void 0,t}}],ie=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})}],ae=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>{const t=Object.assign(Object.assign({},e),{version:1,outputType:e.output_type,outputEmptyResults:e.output_empty_results,outputLocationType:e.output_location_type,outputLocation:e.output_location,outputResultsCount:e.output_results_count});return t.output_type=void 0,t.output_empty_results=void 0,t.output_location_type=void 0,t.output_location=void 0,t.output_results_count=void 0,t}}],oe=[{version:0,up:e=>{const t=Object.assign(Object.assign({},e),{version:0,output_type:void 0===e.output_type?"array":e.output_type});return void 0===t.output_location&&(t.output_location="payload",t.output_location_type="msg"),t}},{version:1,up:e=>{const t=Object.assign(Object.assign({},e),{version:1,startDate:e.startdate,endDate:e.enddate,entityId:e.entityid,outputType:e.output_type,outputLocationType:e.output_location_type,outputLocation:e.output_location,entityIdType:"includes"===e.entityidtype?"regex":"equals"});return t.startdate=void 0,t.enddate=void 0,t.entityid=void 0,t.entityidtype=void 0,t.output_type=void 0,t.output_location_type=void 0,t.output_location=void 0,t}}],se=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,mode:"out"===e.mode?"set":"listen"})}],re=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,state_type:"str",halt_if_type:"str",halt_if_compare:"is",updateIntervalUnits:"seconds"})},{version:2,up:e=>Object.assign(Object.assign({},e),{version:2,updateIntervalType:"num"})},{version:3,up:e=>{const t=Object.assign(Object.assign({},e),{version:3,entityId:e.entity_id,exposeAsEntityConfig:"",ifState:e.halt_if,ifStateType:e.halt_if_type,ifStateOperator:e.halt_if_compare,outputInitially:e.outputinitially,outputOnChanged:e.outputonchanged,outputProperties:[{property:"payload",propertyType:l.Message,value:"",valueType:"entityState"},{property:"data",propertyType:l.Message,value:"",valueType:"entity"},{property:"topic",propertyType:l.Message,value:"",valueType:"triggerId"}],stateType:e.state_type,updateInterval:e.updateinterval});return t.entity_id=void 0,t.updateinterval=void 0,t.outputinitially=void 0,t.outputonchanged=void 0,t.state_type=void 0,t.halt_if=void 0,t.halt_if_type=void 0,t.halt_if_compare=void 0,t.exposeToHomeAssistant=void 0,t.haConfig=void 0,t}}],le=[{version:0,up:e=>{const t=Object.assign(Object.assign({},e),{version:0});return void 0===t.templateLocationType&&(t.templateLocation="template",t.templateLocationType="msg"),void 0===t.resultsLocationType&&(t.resultsLocation="payload",t.resultsLocationType="msg"),t}}],ue=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,mode:"out"===e.mode?"set":"listen"})}],pe=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})}],de=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,exposeAsEntityConfig:"",response:""})}],ce=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})}],ve=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,outputProperties:[{property:"payload",propertyType:"msg",value:"",valueType:"eventData"},{property:"topic",propertyType:"msg",value:"",valueType:"triggerId"}]})},{version:2,up:e=>{var t;const n=Object.assign(Object.assign({},e),{version:2,exposeAsEntityConfig:null!==(t=e.exposeAsEntityConfig)&&void 0!==t?t:""});return n.exposeToHomeAssistant=void 0,n.haConfig=void 0,n}}],ye=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,mode:"out"===e.mode?"set":"listen"})}],ge=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,sunday:!0,monday:!0,tuesday:!0,wednesday:!0,thursday:!0,friday:!0,saturday:!0})},{version:2,up:e=>{const t="jsonata"===e.payloadType&&"$entity().state"===e.payload;return Object.assign(Object.assign({},e),{version:2,outputProperties:[{property:"payload",propertyType:"msg",value:t?"":e.payload,valueType:t?"entityState":e.payloadType},{property:"data",propertyType:"msg",value:"",valueType:"entity"},{property:"topic",propertyType:"msg",value:"",valueType:"triggerId"}],payload:void 0,payloadType:void 0})}},{version:3,up:e=>{const t=Object.assign(Object.assign({},e),{version:3,exposeAsEntityConfig:""});return t.debugenabled=void 0,t.exposeToHomeAssistant=void 0,t.haConfig=void 0,t}}],he=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>Object.assign(Object.assign({},e),{version:1,inputs:1,enableInput:!0})},{version:2,up:e=>{var t;const n=Object.assign(Object.assign({},e),{version:2});return"substring"===e.entityidfiltertype&&(null===(t=e.entityid)||void 0===t?void 0:t.includes(","))&&(n.entityidfiltertype="list",n.entityid=e.entityid.split(",").map((e=>e.trim())).filter((e=>e.length>0))),n}},{version:3,up:e=>{const t=Object.assign(Object.assign({},e),{version:3,entityId:e.entityid,entityIdType:e.entityidfiltertype,debugEnabled:e.debugenabled,customOutputs:e.customoutputs,outputInitially:e.outputinitially,stateType:e.state_type,exposeAsEntityConfig:""});return t.entityid=void 0,t.entityidfiltertype=void 0,t.debugenabled=void 0,t.customoutputs=void 0,t.outputinitially=void 0,t.state_type=void 0,t}},{version:4,up:e=>{const t=Object.assign(Object.assign({},e),{version:4});return void 0===e.stateType&&(t.stateType="str"),t}}],me=[{version:0,up:e=>{const t=Object.assign(Object.assign({},e),{version:0,entityIdFilterType:e.entityIdFilterType||"exact",timeoutType:e.timeoutType||"num"});return void 0===t.blockInputOverrides&&(t.blockInputOverrides=!0),void 0===t.checkCurrentState&&(t.checkCurrentState=!1),t}},{version:1,up:e=>{var t;const n=Object.assign(Object.assign({},e),{version:1});return"substring"===e.entityIdFilterType&&(null===(t=e.entityId)||void 0===t?void 0:t.includes(","))&&(n.entityIdFilterType="list",n.entityId=e.entityId.split(",").map((e=>e.trim())).filter((e=>e.length>0))),n}},{version:2,up:e=>{const t=Object.assign(Object.assign({},e),{version:2,outputProperties:[],entityLocation:void 0,entityLocationType:void 0});return"none"!==e.entityLocationType&&t.outputProperties.push({property:e.entityLocation,propertyType:e.entityLocationType,value:"",valueType:l.Entity}),t}}],fe=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>{const t=Object.assign(Object.assign({},e),{version:1,outputProperties:[{property:"topic",propertyType:"msg",value:"",valueType:"triggerId"}],payloadLocation:void 0,payloadLocationType:void 0,headersLocation:void 0,headersLocationType:void 0});return"none"!==e.payloadLocationType&&t.outputProperties.push({property:e.payloadLocation,propertyType:e.payloadLocationType,value:"",valueType:"data"}),"none"!==e.headersLocationType&&t.outputProperties.push({property:e.headersLocation,propertyType:e.headersLocationType,value:"",valueType:"headers"}),t}},{version:2,up:e=>Object.assign(Object.assign({},e),{version:2,method_post:!0,method_put:!0,method_get:!1,method_head:!1})},{version:3,up:e=>Object.assign(Object.assign({},e),{version:3,exposeAsEntityConfig:""})}],be=[{version:0,up:e=>Object.assign(Object.assign({},e),{version:0})},{version:1,up:e=>{const t=Object.assign(Object.assign({},e),{version:1,exposeAsEntityConfig:""});return t.exposeToHomeAssistant=void 0,t.haConfig=void 0,t}}];const Te={[s.API]:W,[s.BinarySensor]:z,[s.CallSevice]:U,[s.Server]:J,[s.CurrentState]:K,[s.Device]:Z,[s.DeviceConfig]:X,[s.Entity]:Y,[s.EntityConfig]:Q,[s.EventsAll]:ee,[s.EventsCalendar]:te,[s.EventsState]:ne,[s.FireEvent]:ie,[s.GetEntities]:ae,[s.GetHistory]:oe,[s.Number]:se,[s.PollState]:re,[s.RenderTemplate]:le,[s.Select]:ue,[s.Sensor]:pe,[s.Sentence]:de,[s.Switch]:ce,[s.TriggerState]:he,[s.Tag]:ve,[s.Text]:ye,[s.Time]:ge,[s.WaitUntil]:me,[s.Webhook]:fe,[s.Zone]:be};function $e(e){var t;const n=function(e){var t;const n=null!==(t=_e(e))&&void 0!==t?t:[],i=n.reduce(((e,t)=>t.version>e?t.version:e),0);return i}(e.type);if(void 0!==e.version&&e.version>=n)return e;const i=null===(t=function(e,t=-1){const n=_e(e),i=null==n?void 0:n.find((e=>e.version===Number(t)+1));return i}(e.type,e.version))||void 0===t?void 0:t.up;if(i){return $e(i(e))}return e}function _e(e){return Te[e]}const Se=(e,t)=>{let n;for(n in t)t[n].forEach((t=>{RED.nodes.addLink(Object.assign(Object.assign({},t),{[n]:RED.nodes.node(e)}))}))},Ee=()=>{let e;do{e=RED.nodes.id()}while(RED.nodes.node(e));return e},we=e=>{const t={source:RED.nodes.getNodeLinks(e.id),target:RED.nodes.getNodeLinks(e.id,1)},n=Ee();if(e.g){const t=RED.nodes.node(e.id);t&&RED.group.removeFromGroup(RED.nodes.group(e.g),t)}RED.nodes.remove(e.id),(e=>{var t,n;RED.nodes.import({type:s.EntityConfig,id:e.id,server:e.server,deviceConfig:"",name:`${e.entityType.replace("_"," ")} config for ${e.name||e.id}`,version:RED.settings.get("haEntityConfigVersion",0),entityType:e.entityType,haConfig:null!==(t=e.config)&&void 0!==t?t:[],resend:null!==(n=e.resend)&&void 0!==n&&n})})(e),((e,t)=>{var n,i,o,r,l;let u={id:t,name:e.name,inputs:1,outputs:1,version:0,g:e.g,x:e.x,y:e.y,z:e.z,entityConfig:e.id};switch(e.entityType){case a.BinarySensor:case a.Sensor:u=Object.assign(Object.assign({},u),{type:e.entityType===a.Sensor?s.Sensor:s.BinarySensor,state:null!==(n=e.state)&&void 0!==n?n:"payload",stateType:null!==(i=e.stateType)&&void 0!==i?i:"msg",attributes:null!==(o=e.attributes)&&void 0!==o?o:[],inputOverride:null!==(r=e.inputOverride)&&void 0!==r?r:"allow",outputProperties:"none"===e.outputLocationType?[]:[{property:e.outputLocation,propertyType:e.outputLocationType,value:"",valueType:"data"}]});break;case a.Switch:default:u=Object.assign(Object.assign({},u),{type:s.Switch,outputs:2,outputOnStateChange:null!==(l=e.outputOnStateChange)&&void 0!==l&&l,enableInput:!0,outputProperties:"none"===e.outputPayloadType?[]:[{property:"payload",propertyType:"msg",value:e.outputPayload,valueType:e.outputPayloadType}]})}RED.nodes.import(u)})(e,n),Se(n,t);const i=RED.nodes.node(n);i&&(RED.nodes.moveNodeToTab(i,e.z),e.g&&RED.group.addToGroup(RED.nodes.group(e.g),i),i.changed=!0),RED.view.redraw(!0)},De=(e,t)=>{const n={source:RED.nodes.getNodeLinks(e.id),target:RED.nodes.getNodeLinks(e.id,1)};if(e.g){const t=RED.nodes.node(e.id);t&&RED.group.removeFromGroup(RED.nodes.group(e.g),t)}RED.nodes.import([{type:s.EntityConfig,id:e.id,server:e.server,deviceConfig:"",name:`exposed as for ${e.name||e.id}`,version:RED.settings.get("haEntityConfigVersion",0),entityType:a.Switch,haConfig:null!=t?t:[],resend:!1}],{importMap:{[e.id]:"replace"}});const i=Ee();RED.nodes.import(Object.assign(Object.assign({},e),{id:i,exposeAsEntityConfig:e.id})),Se(i,n);const o=RED.nodes.node(i);o&&(RED.nodes.moveNodeToTab(o,e.z),e.g&&RED.group.addToGroup(RED.nodes.group(e.g),o),o.changed=!0),RED.view.redraw(!0)};let Ie;const xe=[s.Device,s.EventsAll,s.EventsState,s.PollState,s.Tag,s.Time,s.Zone];function Oe(e){const t=RED.nodes.convertNode(e,!1),n=xe.includes(e.type)&&(!0===e.exposeToHomeAssistant||e.type===s.Device&&e.version<1)?t.haConfig:void 0,i=$e(t);let a;for(a in"type"in i&&i.type===s.Entity?we(i):n&&De(i,n),i)void 0===i[a]?delete e[a]:e[a]=i[a];e.changed=!0,RED.editor.updateNodeProperties(e);const o=$("#upgrade-ha-node");return o.is(":visible")&&0===Re()&&o.hide(),e}function Ce(){const e="home-assistant.ui.migrations",t=p(`${e}.button_ok`),n=p(`${e}.button_cancel`);$("#ha-dialog-confirm").dialog({resizable:!1,height:"auto",width:400,modal:!0,buttons:{[t]:function(){$(this).dialog("close"),function(){const e=[],t=t=>{ke(t)&&!je(t)&&e.push(t)};RED.nodes.eachNode(t),RED.nodes.eachConfig(t),e.forEach((e=>Oe(e))),RED.nodes.dirty(!0),RED.notify(p("home-assistant.ui.migrations.all_nodes_updated")),RED.view.redraw()}()},[n]:function(){$(this).dialog("close")}}})}function je(e){const t=RED.settings.get(`${e.type.split("-").reduce(((e,t,n)=>e.concat(`${n?t[0].toUpperCase():t[0]}${t.slice(1)}`)),[]).join("")}Version`,-1);const n=Pe(e)&&void 0===e.version?e._def.defaults.version.value:e.version;return void 0!==n&&n>=t}function ke(e){const t=RED.nodes.registry.getNodeSetForType(e.type);return"node-red-contrib-home-assistant-websocket"===(null==t?void 0:t.module)}function Pe(e){return(null==e?void 0:e.type)&&[s.Server,s.EntityConfig,s.DeviceConfig].includes(e.type)}function Re(){let e=0;const t=t=>{ke(t)&&!je(t)&&e++};return RED.nodes.eachNode(t),RED.nodes.eachConfig(t),e}const Ae="#custom-outputs";let Le,Be=[];const Ne={config:{value:"config",label:"config.",hasValue:!0},deviceId:{value:"deviceId",label:"device id",hasValue:!1},entity:{value:"entity",label:"entity",hasValue:!1},entityId:{value:"triggerId",label:"entity id",hasValue:!1},entityState:{value:"entityState",label:"entity state",hasValue:!1},eventData:{value:"eventData",label:"event data",hasValue:!1},headers:{value:"headers",label:"headers",hasValue:!1},params:{value:"params",label:"params",hasValue:!1},prevEntity:{value:"prevEntity",label:"previous entity",hasValue:!1},previousValue:{value:"previousValue",label:"previous value",hasValue:!1},results:{value:"results",label:"results",hasValue:!1},receivedData:{value:"data",label:"received data",hasValue:!1},sentData:{value:"data",label:"sent data",hasValue:!1},tagId:{value:"triggerId",label:"tag id",hasValue:!1},timeSinceChangedMs:{value:"timeSinceChangedMs",label:"timeSinceChangedMs",hasValue:!1},triggerId:{value:"triggerId",label:"trigger id",hasValue:!1},value:{value:"value",label:"value",hasValue:!1},calendarItem:{value:"calendarItem",label:"calendar item",hasValue:!1}},He=[Ne.config,l.Flow,l.Global,l.String,l.Number,l.Boolean,l.Date,l.JSONata];function Ve(e=[],{element:t=Ae,extraTypes:n=[]}={}){Le=$(t),Be=n,Le.editableList({addButton:!0,removable:!0,sortable:!0,height:"auto",header:$("<div>").append(p("home-assistant.label.output_properties")),addItem:function(e,t,n){e.css({overflow:"hidden",whiteSpace:"nowrap"});const i=$("<div />").appendTo(e),a=$("<input/>",{class:"property-name",type:"text"}).css("width","30%").appendTo(i).typedInput({types:[l.Message,l.Flow,l.Global]});$("<div/>",{style:"display:inline-block; padding:0px 6px;"}).text("=").appendTo(i);const o=$("<input/>",{class:"property-value",type:"text"}).css("width","calc(70% - 30px)").appendTo(i).typedInput({default:"str",types:Me()});n.property&&a.typedInput("value",n.property),n.propertyType&&a.typedInput("type",n.propertyType),n.value&&o.typedInput("value",n.value),n.valueType&&o.typedInput("type",n.valueType)}}),Le.editableList("addItems",e)}function Me(){let e=Be.reduce(((e,t)=>t in Ne?[...e,Ne[t]]:e),[]);if(e=[...e,...He],Be.includes(l.Message)){const t=e.indexOf(l.Flow);e.splice(t,0,l.Message)}return e}function Fe(){const e=$(Ae).editableList("items"),t=[];return e.each((function(){const e=$(this).find(".property-name"),n=$(this).find(".property-value"),i=e.typedInput("value"),a=e.typedInput("type"),o=n.typedInput("value"),s=n.typedInput("type");t.push({property:i,propertyType:a,value:o,valueType:s})})),t}function qe(e){return void 0===e||Array.isArray(e)&&!e.some((e=>0===e.property.length))}var Ge,We;!function(e){e.Config="config",e.HomeAssistant="home_assistant",e.HomeAssistantDeprecated="home_assistant_deprecated",e.HomeAssistantEntities="home_assistant_entities"}(Ge||(Ge={})),function(e){e.Action="#46B1EF",e.Alpha="#E78BB9",e.Api="#7CDFFD",e.Beta="#77DD77",e.Data="#5BCBF7",e.Deprecated="#A6BBCF",e.Event="#399CDF",e.HaBlue="#41BDF5"}(We||(We={}));var ze={alphaWarning:e=>$.parseHTML(`\n            <div class="ui-state-error ha-alpha-box">\n                Alpha version: At this point anything could change or not work.\n                <br />\n                Found an issue? Post it in\n                <a\n                    href="https://github.com/zachowj/node-red-contrib-home-assistant-websocket/issues"\n                    target="_blank"\n                    rel="noreferrer"\n                >\n                    issues\n                </a>\n                . Have questions or comments? Post them\n                <a\n                    href="https://github.com/zachowj/node-red-contrib-home-assistant-websocket/discussions/${e}"\n                    target="_blank"\n                    rel="noreferrer"\n                >\n                    here\n                </a>\n                .\n            </div>\n        `),betaWarning:e=>$.parseHTML(`\n            <div class="ui-state-error ha-beta-box">\n                Beta version: Config should be stable and hopefully not too many bugs.\n                <br />\n                Found an issue? Post it in\n                <a\n                    href="https://github.com/zachowj/node-red-contrib-home-assistant-websocket/issues"\n                    target="_blank"\n                    rel="noreferrer"\n                >\n                    issues\n                </a>\n                . Have questions or comments? Post them\n                <a\n                    href="https://github.com/zachowj/node-red-contrib-home-assistant-websocket/discussions/${e}"\n                    target="_blank"\n                    rel="noreferrer"\n                >\n                    here\n                </a>\n                .\n            </div>\n        `),labelStyle:function(){const e=[];return je(this)||e.push("ha-node-label-legacy"),this.name&&e.push("node_label_italic"),e.join(" ")},setup:e=>{$("#dialog-form, #node-config-dialog-edit-form").addClass("home-assistant"),function(e){ke(e)&&!je(e)&&(Pe(e=Oe(e))||RED.events.on("editor:close",(function t(){RED.events.off("editor:close",t),RED.editor.edit(e)})),RED.nodes.dirty(!0),RED.tray.close(),RED.notify(p("home-assistant.ui.migrations.node_schema_updated")))}(e)}};let Ue,Je,Ke,Ze=!1;function Xe(e,t,n){Ue=$(t),Ke=e,Ke.server||function(){let e;RED.nodes.eachConfig((t=>(t.type!==s.Server||e||(e=t.id),!0))),e&&Ue.val(e)}(),Je=Ue.val(),setTimeout((()=>{Ue.on("change",(()=>{Je=Ue.val(),null==n||n(Je)}))}),500)}function Ye(){return Je}function Qe(e,t){let n=Ue.val();(Ke.server||n&&"_ADD_"!==n)&&(Je=Ke.server||n,et(e,t)),Ue.on("change",(()=>{Je=Ue.val(),Je!==n&&(n=Je,et(e,t))}))}function et(e,t){"_ADD_"!==Je&&$.getJSON(`homeassistant/${e}/${Je}`).done((e=>{t(e)})).fail((e=>{503===e.status&&!1===Ze&&(Ze=!0,RED.notify(Ke._("config-server.errors.server_deploy")),setTimeout((()=>Ze=!1),2e3))}))}function tt(e,t,{params:n={}}){let i=`homeassistant/${t}/${Ue.val()}`;$.isEmptyObject(n)||(i+=`?${$.param(n)}`),$.getJSON(i).done((t=>{e(t)}))}function nt(e,t={}){let n=`homeassistant/${e}/${Ue.val()}`;return $.isEmptyObject(t)||(n+=`?${$.param(t)}`),new Promise(((e,t)=>{$.getJSON(n).done((t=>e(t))).fail((e=>t(e)))}))}const it=e=>function(e,t){const n=S(e);if(t&&(null==n?void 0:n.length)){const e=n.find((e=>e.area_id===t));if(e)return e.name}return p("ha-device.ui.no_area")}(Je,e),at=()=>Object.values(function(e){var t;return null!==(t=m[e])&&void 0!==t?t:{}}(Je)),ot=()=>function(e){var t;return null!==(t=f[e])&&void 0!==t?t:{}}(Je),st=()=>function(e){var t;return null!==(t=b[e])&&void 0!==t?t:{areas:{},devices:{}}}(Je),rt=()=>{const e=RED.nodes.node(Je);return{areaSelector:null==e?void 0:e.areaSelector,deviceSelector:null==e?void 0:e.deviceSelector,entitySelector:null==e?void 0:e.entitySelector,status:{separator:null==e?void 0:e.statusSeparator,year:null==e?void 0:e.statusYear,month:null==e?void 0:e.statusMonth,day:null==e?void 0:e.statusDay,hourCycle:null==e?void 0:e.statusHourCycle,timeFormat:null==e?void 0:e.statusTimeFormat}}},lt={category:Ge.HomeAssistant,color:We.HaBlue,inputs:1,outputs:1,icon:"font-awesome/fa-paper-plane-o",paletteLabel:"API",label:function(){return this.name||"API"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haApiVersion",0)},debugenabled:{value:!1},protocol:{value:"websocket"},method:{value:"get"},path:{value:""},data:{value:"",validate:RED.validators.typedInput({type:"dateType",allowBlank:!0})},dataType:{value:"jsonata"},responseType:{value:"json"},outputProperties:{value:[{property:"payload",propertyType:"msg",value:"",valueType:"results"}],validate:qe},location:{value:void 0},locationType:{value:void 0}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),$("#node-input-data").typedInput({types:["jsonata","json"],typeField:"#node-input-dataType"}),$("#node-input-protocol").on("change",(function(){const e="http"===$(this).val();$(".http").toggle(e),$("#node-input-method").trigger("change")})).trigger("change"),$("#node-input-method").on("change",(function(){const e="http"===$("#node-input-protocol").val()&&"get"===$("#node-input-method").val()?"Params":"Data";$("#data-label").text(e)})),$("#node-input-location").typedInput({types:["msg","flow","global",{value:"none",label:"None",hasValue:!1}],typeField:"#node-input-locationType"}),Ve(this.outputProperties,{extraTypes:["results"]})},oneditsave:function(){this.outputProperties=Fe()}},ut="node-red-contrib-home-assistant-websocket/all:ha-entity-config.data.label",pt=(e,t,n)=>$("<input />",{type:"text",name:"value",value:t,id:e,"data-property":n.id}).attr("autocomplete","off"),dt=(e,t)=>{const n=`ha-config-${t.id}`,i=$("<div />",{class:"form-row ha-config-row","data-type":t.type}),a=RED._(`${ut}.${t.id}`),o=$("<label>",{for:n}).text(a);switch(i.append(o," "),t.type){case"date":i.append(((e,t,n)=>$("<input />",{type:"date",name:"value",value:t,id:e,"data-property":n.id}))(n,e,t));break;case"datetime":i.append(((e,t,n)=>{const i=new Date(t),a=e=>e<10?"0"+e:e,o=t?`${i.getFullYear()}-${a(i.getMonth()+1)}-${a(i.getDate())}T${a(i.getHours())}:${a(i.getMinutes())}`:"";return $("<input />",{type:"datetime-local",name:"value",value:o,id:e,"data-property":n.id})})(n,e,t));break;case"editableList":o.css({verticalAlign:"top"}),i.append(((e,t,n)=>{const i=$("<ol />",{id:e}),a=$("<div />",{style:"width: 70%;display: inline-block;"}).append(i);return i.editableList({addButton:!0,removable:!0,sortable:!0,height:"auto",addItem:function(e,t,n){$("<input />",{type:"text",value:"string"==typeof n?n:"",style:"width: 95%"}).appendTo(e)}}),i.editableList("addItems",Array.isArray(t)?t:n),a})(n,e,t.values));break;case"number":i.append(((e,t,n)=>$("<input />",{type:"number",name:"value",value:t,id:e,"data-property":n.id}).attr("autocomplete","off"))(n,e,t));break;case"select":i.append(((e,t,n)=>{const i=$("<select />",{name:"value",id:e,style:"width: 70%","data-property":n.id}),a=`${ut}.${n.id}_options`;return n.values.forEach((e=>{$("<option />",{value:e,text:e?RED._(`${a}.${e}`):"",selected:e===t}).appendTo(i)})),i})(n,e,t));break;case"unit_of_measurement":i.append(((e,t,n)=>{const i=$("#ha-config-device_class").val(),a=n.values[i];if(""===i||null===a)return pt(e,t,n);const o=$("<select />",{name:"value",id:e,style:"width: 70%","data-property":n.id});return a.forEach((e=>{$("<option />",{value:e,text:e,selected:e===t}).appendTo(o)})),o})(n,e,t));break;case"string":i.append(pt(n,e,t))}return i},ct=(e,t="entityConfig")=>{$(`#node-input-lookup-${t}`).on("click",(function(){"_ADD_"===$(`#node-input-${t}`).val()&&$("body").data("haEntityType",e)}))},vt=["msg","flow","global","jsonata","str","num","bool"],yt=["str","num","bool","date","jsonata","msg","flow","global"],gt={category:Ge.HomeAssistantEntities,color:We.HaBlue,inputs:1,outputs:1,icon:"font-awesome/fa-check-circle-o",align:"right",paletteLabel:"binary sensor",label:function(){return this.name||"binary sensor"},labelStyle:ze.labelStyle,defaults:{name:{value:""},entityConfig:{value:"",type:s.EntityConfig,filter:e=>"binary_sensor"===e.entityType,required:!0},version:{value:RED.settings.get("haBinarySensorVersion",0)},state:{value:"payload"},stateType:{value:"msg"},attributes:{value:[]},inputOverride:{value:"allow"},outputProperties:{value:[],validate:qe}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),A(this);$("#node-input-state").typedInput({types:vt,typeField:"#node-input-stateType",type:this.stateType}),ct(a.BinarySensor),$("#attributes").editableList({removable:!0,addButton:"add attribute",header:$("<div>").append($.parseHTML("<div style='width:40%; display: inline-grid'>Attribute Key</div><div style='display: inline-grid'>Value</div>")),addItem:function(e,t,n){const i=$("<div />").appendTo(e);$("<input />",{type:"text",name:"property",style:"width: 40%;margin-right: 5px;"}).attr("autocomplete","disable").appendTo(i).val(n.property);const a=$("<input />",{type:"text",name:"value",style:"width: 55%;"}).appendTo(i).val(n.value);a.typedInput({types:yt}),a.typedInput("type",n.valueType)}}).editableList("addItems",this.attributes),Ve(this.outputProperties,{extraTypes:["sentData"]})},oneditsave:function(){this.attributes=[];const e=this;$("#attributes").editableList("items").each((function(){const t=$(this);e.attributes.push({property:t.find("input[name=property]").val(),value:t.find("input[name=value]").typedInput("value"),valueType:t.find("input[name=value]").typedInput("type")})})),this.outputProperties=Fe()}},ht={category:Ge.HomeAssistantEntities,color:We.HaBlue,inputs:0,outputs:1,icon:"font-awesome/fa-hand-o-up",align:"left",paletteLabel:"button",label:function(){return this.name||"button"},labelStyle:ze.labelStyle,defaults:{name:{value:""},version:{value:RED.settings.get("haButtonVersion",0)},debugenabled:{value:!1},outputs:{value:1},entityConfig:{value:"",type:s.EntityConfig,filter:e=>"button"===e.entityType,required:!0},outputProperties:{value:[{property:"payload",propertyType:"msg",value:"",valueType:"entityState"},{property:"topic",propertyType:"msg",value:"",valueType:"triggerId"},{property:"data",propertyType:"msg",value:"",valueType:"entity"}],validate:qe}},oneditprepare:function(){ze.setup(this),A(this),ct(a.Button),Ve(this.outputProperties,{extraTypes:["entity","entityState","entityId"]})},oneditsave:function(){this.outputProperties=Fe()}};function mt(e){return/^\$\{[a-zA-Z_][a-zA-Z0-9_]*\}$/.test(e)}function ft(e){return/{{(?:(?!}}).+)}}/g.test(e)}var bt,Tt;!function(e){e.Any="any",e.Custom="custom",e.None="none"}(bt||(bt={})),function(e){e.Entities="entitiesSelect2"}(Tt||(Tt={}));const $t={theme:"nodered",templateResult:e=>$(`<div>${e.text}${e.title?`<p class="sublabel">${e.title}</p>`:""}</div>`),matcher:(e,t)=>{var n,i;if(null==e.term||""===e.term.trim())return t;const a=e.term.toLowerCase();return void 0===t.text?null:(null===(n=t.text)||void 0===n?void 0:n.toLowerCase().indexOf(a))>-1||(null===(i=null==t?void 0:t.title)||void 0===i?void 0:i.toLowerCase().indexOf(a))>-1?t:null}},_t=({multiple:e=!1,tags:t=bt.None,customTags:n=[],displayIds:i=!1,data:a,ajax:o})=>{const s=Object.assign(Object.assign({},$t),{data:a,multiple:e,dropdownAutoWidth:!0});return(null==o?void 0:o.serverId)&&(s.ajax={url:`homeassistant/${o.endpoint}/${o.serverId}`,dataType:"json",delay:250}),s.tags=t===bt.Any||t===bt.Custom,t===bt.Custom&&(s.createTag=e=>{if(e.term.endsWith("#")){const t=e.term.substring(0,e.term.length-1);return{id:t,text:t}}return ft(e.term)||mt(e.term)||n.includes(e.term)?{id:e.term,text:e.term}:null}),i&&(s.templateSelection=e=>e.id.toString()),s},St=(e,t,n)=>e?(Array.isArray(e)?e:[e]).reduce(((e,i)=>(((null==n?void 0:n.includeUnknownIds)&&i||ft(i)||mt(i))&&!t.find((e=>(e=>(null==n?void 0:n.property)?e[null==n?void 0:n.property]:e)(e)===i))&&e.push({id:i,text:i,selected:!0}),e)),[]):[],Et=e=>(v(e)?e:$(e)).hasClass("select2-hidden-accessible"),wt=()=>{const e=$("#node-input-domain").val(),t=$("#node-input-service").val();return[null==e?void 0:e.toLowerCase(),null==t?void 0:t.toLowerCase()]},Dt=()=>{var e;const t=$("#service-data-desc"),n=$(".service-description",t),i=$("tbody",t),a=$(".unknown-service",t),o=$(".known-service",t),s=$("#example-data"),[r,l]=wt(),u=ot(),p=null===(e=null==u?void 0:u[r])||void 0===e?void 0:e[l];if(p){const e=p.description?p.description:"No description provided by home assistant",t=p.fields,u=Object.keys(t).reduce(((e,n)=>{var i,a;const o=t[n];return o.description||o.example?(e.push(`<tr><td><code>${n}</code></td><td>${null!==(i=t[n].description)&&void 0!==i?i:""}</td><td>${null!==(a=t[n].example)&&void 0!==a?a:""}</td></tr>`),e):e}),[]);n.html(e),$("#service-data-desc .title").html(`${r}.${l}`),u.length?($("#service-data-table").show(),s.show(),i.html(u.length>0?u.join(""):"")):($("#service-data-table").hide(),s.hide(),n.append("<p>No fields documented by Home Assistant<p>")),a.hide(),o.show()}else a.show(),o.hide(),s.hide(),$("#service-data-desc .title").val("")},It=()=>{var e;const t=$("#node-input-entityId"),n=$("#node-input-data"),[i,a]=wt(),o=$("#node-input-server").val();if(i&&a&&o){const o=ot(),s=null===(e=null==o?void 0:o[i])||void 0===e?void 0:e[a];if(s){const e=s.fields,i=Object.keys(e).reduce(((n,i)=>{const a=e[i].example;if("entity_id"===i)return(null==a?void 0:a.toString())&&t.val(),n;if(void 0===a)return n;if("string"==typeof a)if("["===a[0]&&"]"===a[a.length-1])try{n[i]=JSON.parse(a)}catch(e){}else'"'===a[0]&&'"'===a[a.length-1]?n[i]=a.substring(1,a.length-1):n[i]=a;else"number"!=typeof a||isNaN(a)?a&&(n[i]=a):n[i]=Number(a);return n}),{});Object.keys(i).length&&n.typedInput("value",JSON.stringify(i))}}},xt="#node-input-areaId",Ot="#node-input-deviceId",Ct="#node-input-entityId",jt="none",kt="all",Pt="entity_only",Rt=({selectedIds:e,filter:t})=>{const n=$(xt),i=S(Je),a=null!=e?e:n.val();n.empty();const o=(t?i.filter(t):i).map((e=>({id:e.area_id,text:e.name,selected:a.includes(e.area_id)}))).sort(D(["text"])).concat(St(a,i,{property:"area_id",includeUnknownIds:!0}));n.select2(_t({data:o,multiple:!0,tags:bt.Custom,displayIds:"id"===rt().areaSelector})).maximizeSelect2Height(),y(n)},At=({selectedIds:e,filter:t})=>{const n=$(Ot),i=E(Je),a=null!=e?e:n.val();n.empty();const o=(t?i.filter(t):i).map((e=>{var t;return{id:e.id,text:null!==(t=e.name_by_user)&&void 0!==t?t:e.name,selected:a.includes(e.id),title:it(e.area_id)}})).sort(D(["text"])).concat(St(a,i,{property:"id",includeUnknownIds:!0}));n.select2(_t({data:o,multiple:!0,tags:bt.Custom,displayIds:"id"===rt().deviceSelector})).maximizeSelect2Height(),y(n)},Lt=()=>{var e,t,n,i,a;const o=ot(),[s,r]=wt();return 0!==Object.keys(o).length&&(null===(e=null==o?void 0:o[s])||void 0===e?void 0:e[r])&&void 0===(null===(n=null===(t=null==o?void 0:o[s])||void 0===t?void 0:t[r])||void 0===n?void 0:n.target)?void 0!==(null===(a=null===(i=o[s])||void 0===i?void 0:i[r])||void 0===a?void 0:a.fields.entity_id)?Pt:jt:kt},Bt=()=>{var e,t,n,i;const a=ot(),[o,s]=wt(),r=null===(i=null===(n=null===(t=null===(e=null==a?void 0:a[o])||void 0===e?void 0:e[s])||void 0===t?void 0:t.target)||void 0===n?void 0:n.entity)||void 0===i?void 0:i.domain;return r?e=>e.entity_id.startsWith(`${r}.`):void 0},Nt=(e,t)=>{var n,i,a,o;const s=st()[e],r=ot(),[l,u]=wt(),p=null===(o=null===(a=null===(i=null===(n=null==r?void 0:r[l])||void 0===n?void 0:n[u])||void 0===i?void 0:i.target)||void 0===a?void 0:a.entity)||void 0===o?void 0:o.domain;return p?e=>{var n;return null===(n=s[e[t]])||void 0===n?void 0:n.includes(p)}:void 0},Ht=()=>{const e=Lt(),t=$(`${xt}, ${Ot}, ${Ct}`);e===jt?t.parent().hide():e===Pt?(t.parent().hide(),$(Ct).parent().show()):t.parent().show()},Vt=({areaId:e,deviceId:t,entityId:n}={})=>{const i=Lt();i===kt||i===Pt?(i===kt?(Rt({selectedIds:e,filter:Nt("areas","area_id")}),At({selectedIds:t,filter:Nt("devices","id")})):$(`${xt}, ${Ot}`).val(null).trigger("change"),(({selectedIds:e,filter:t})=>{const n=$(Ct),i=Object.values(at()),a=null!=e?e:n.val();n.empty();const o=(t?i.filter(t):i).map((e=>{var t;return{id:e.entity_id,text:null!==(t=e.attributes.friendly_name)&&void 0!==t?t:e.entity_id,selected:a.includes(e.entity_id),title:e.entity_id}})).sort(D(["text"])).concat(St(a,i,{property:"entity_id",includeUnknownIds:!0}));n.select2(_t({data:o,multiple:!0,tags:bt.Any,displayIds:"id"===rt().entitySelector})).maximizeSelect2Height(),y(n)})({selectedIds:n,filter:Bt()})):$(`${xt}, ${Ot}, ${Ct}`).val(null).trigger("change")},Mt={category:Ge.HomeAssistant,color:We.HaBlue,inputs:1,outputs:1,icon:"ha-call-service.svg",align:"right",paletteLabel:"call service",label:function(){return this.name||(this.domain||this.service?`${this.domain||"<domain>"}.${this.service||"<service>"}`:"call service")},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("apiCallServiceVersion",0)},debugenabled:{value:!1},domain:{value:""},service:{value:""},areaId:{value:[]},deviceId:{value:[]},entityId:{value:[]},data:{value:"",validate:RED.validators.typedInput({type:"dateType",allowBlank:!0})},dataType:{value:"jsonata"},mergeContext:{value:""},mustacheAltTags:{value:!1},outputProperties:{value:[],validate:qe},queue:{value:"none"},target:{value:void 0},output_location:{value:void 0},output_location_type:{value:void 0},service_domain:{value:void 0},mergecontext:{value:void 0}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server");const e=$("#node-input-domain"),t=$("#node-input-service"),n=$("#node-input-data"),i=$("#node-input-dataType"),a=$("#example-data"),o=n=>{var i;const a=ot(),o=null===(i=e.val())||void 0===i?void 0:i.toLowerCase(),s=!(null==a?void 0:a[o])||ft(o)?Array.from(new Set(Object.values(a).map((e=>Object.keys(e))).flat())):Object.keys(a[o]),r=s.map((e=>({id:e,text:e,selected:e===n}))).sort(D(["text"])).concat(St(n,s,{includeUnknownIds:!0}));t.empty().select2(_t({data:r,tags:bt.Custom})).maximizeSelect2Height(),n||t.val(-1).trigger("change")};e.on("select2:select",(()=>{o(),Vt(),Ht(),Dt()})),t.on("select2:select",(()=>{Vt(),Ht(),Dt()})),$("#node-input-server").on("change",(()=>{(t=>{const n=ot(),i=null!=t?t:e.val(),a=Object.keys(n).map((e=>({id:e,text:e,selected:e===i}))).sort(D(["text"])).concat(St(i,Object.keys(n),{includeUnknownIds:!0}));e.empty().select2(_t({tags:bt.Custom,data:a})).maximizeSelect2Height(),i||e.val(-1).trigger("change")})(this.domain),o(this.service),Vt({entityId:this.entityId,areaId:this.areaId,deviceId:this.deviceId}),Ht(),Dt()})),a.on("click",It),n.typedInput({default:"jsonata",types:["jsonata","json"],typeField:"#node-input-dataType"}),n.on("change",(()=>{$("#mustacheAltTags").toggle("json"===i.val())})),Ve(this.outputProperties,{extraTypes:["sentData","results","msg"]})},oneditsave:function(){this.outputProperties=Fe()}};var Ft,qt;const Gt=null===(qt=null===(Ft=null===Intl||void 0===Intl?void 0:Intl.DateTimeFormat())||void 0===Ft?void 0:Ft.resolvedOptions())||void 0===qt?void 0:qt.locale,Wt={month:"short",day:"numeric",hour:"numeric",minute:"numeric"};const zt={category:Ge.Config,defaults:{name:{value:"Home Assistant",required:!1},version:{value:RED.settings.get("serverVersion",0)},addon:{value:!1},rejectUnauthorizedCerts:{value:!0},ha_boolean:{value:"y|yes|true|on|home|open"},connectionDelay:{value:!0},cacheJson:{value:!0},heartbeat:{value:!1},heartbeatInterval:{value:30,validate:function(e){return!$("#node-config-input-heartbeat").is(":checked")||RED.validators.number()(e)&&Number(e)>=10}},areaSelector:{value:"friendlyName"},deviceSelector:{value:"friendlyName"},entitySelector:{value:"friendlyName"},statusSeparator:{value:": "},statusYear:{value:"hidden"},statusMonth:{value:"short"},statusDay:{value:"numeric"},statusHourCycle:{value:"default"},statusTimeFormat:{value:"h:m"},enableGlobalContextStore:{value:!1}},credentials:{host:{type:"text"},access_token:{type:"text"}},icon:"font-awesome/fa-home",label:function(){return this.name||"Home Assistant"},oneditprepare:function(){ze.setup(this);const e=$("#node-config-input-addon"),t=$("#node-config-input-host");!1===this.rejectUnauthorizedCerts&&$("#accept_unauthorized_certs").prop("checked",!0);function n(){$("#server-info").toggle(!e.prop("checked")),$(".addon").toggle(e.prop("checked"))}["http://hassio/homeassistant","http://supervisor/core"].includes(t.val())&&e.prop("checked",!0),n(),e.on("click",(function(){n()}));try{t.autocomplete("destroy")}catch(e){}const i=$("#discoverInstances");i.on("click",(function(){if($(this).hasClass("disabled"))return;const e=$("i",this).removeClass("fa-search").addClass("spinner");i.addClass("disabled"),t.autocomplete({source:(e,t)=>{$.ajax({dataType:"json",url:"/homeassistant/discover",cache:!1}).done((e=>{t(e)}))},minLength:0,response:()=>{e.addClass("fa-search").removeClass("spinner"),i.removeClass("disabled")},close:()=>t.autocomplete("destroy")}).autocomplete("search","")})),$("#node-config-input-heartbeat").on("change",(function(){$("#heartbeatIntervalRow").toggle(this.checked)})),$("#node-config-input-statusHourCycle").on("change",(function(){const e={hour:"numeric",minute:"numeric"},t=$(this).val();t&&"default"!==t&&(e.hourCycle=t),$("#node-config-input-statusTimeFormat").children().each((function(){const t=$(this);switch(t.val()){case"h:m:s":e.second="numeric";break;case"h:m:s.ms":e.second="numeric",e.fractionalSecondDigits=3}const n=function({date:e=new Date,locale:t=(null!=Gt?Gt:"en-US"),options:n=Wt}){return new Intl.DateTimeFormat(t,n).format(e)}({date:new Date(2022,1,1,3,4,5,6),options:e});t.text(n)}))})).trigger("change")},oneditsave:function(){const e=$("#node-config-input-addon").is(":checked"),t=$("#node-config-input-host").val();if(e)this.addon=!0,this.rejectUnauthorizedCerts=!0;else{const e=document.createElement("a");e.href=t,t===e.origin||mt(t)||RED.notify("Invalid format of Base URL: "+t),this.rejectUnauthorizedCerts=!$("#accept_unauthorized_certs").prop("checked"),this.connectionDelay=!1}}},Ut={serverId:"#node-input-server",type:"entities"};function Jt({root:e,options:t}){const n=v(e)?e:$(e),i=Object.assign(Object.assign({},Ut),t),a=$(i.serverId).val(),o=i.type;n.autocomplete({source:(e,t)=>{const n=e.term.toLowerCase(),i=function(e,t){let n=[];switch(t){case"entities":{if(!(e in m))return[];const t="attributes.friendly_name";n=Object.values(m[e]).map((e=>({value:e.entity_id,label:c(t,e)||e.entity_id}))).sort(_);break}case"properties":if(!(e in m))return[];n=Object.values(m[e]).map((e=>({value:e.entity_id,label:e.state}))).sort(_);break;case"trackers":{if(!(e in m))return[];const t="attributes.friendly_name";n=Object.values(m[e]).filter((e=>e.entity_id.startsWith("person.")||e.entity_id.startsWith("device_tracker."))).map((e=>({value:e.entity_id,label:c(t,e)||e.entity_id}))).sort(_);break}case"zones":{if(!(e in m))return[];const t="attributes.friendly_name";n=Object.values(m[e]).filter((e=>e.entity_id.startsWith("zone."))).map((e=>({value:e.entity_id,label:c(t,e)||e.entity_id}))).sort(_);break}case"calendars":{if(!(e in m))return[];const t="attributes.friendly_name";n=Object.values(m[e]).filter((e=>e.entity_id.startsWith("calendar."))).map((e=>({value:e.entity_id,label:c(t,e)||e.entity_id}))).sort(_);break}}return n}(a,o).filter((e=>e.value.toLowerCase().includes(n)||e.label.toLowerCase().includes(n)));t(i)},minLength:0}).autocomplete("instance")._renderItem=(e,t)=>$("<li>").append(`<div>${t.label}<p class="sublabel">${t.value}</p></div>`).appendTo(e)}const Kt=function(e,t,n,i){const a=$(e),o=$(n),s={value:"entity",label:"entity."},r=["str","num","bool","re","jsonata","msg","flow","global",s];"currentState"!==i&&r.splice(5,1),a.after(' <a id="clearIfState" class="editor-button"><i class="fa fa-remove"></i></a>');const l=$("#clearIfState");a.typedInput({default:"str",types:r,typeField:t}),o.on("change",(function(){const e=$(this);let t=r,n=["flow","global",s];switch(r.includes("msg")&&(n=["msg",...n]),e.val()){case"is":case"is_not":break;case"lt":case"lte":case"gt":case"gte":t=["num","jsonata",...n];break;case"includes":case"does_not_include":t=["str","jsonata",...n];break;case"jsonata":t=["jsonata"]}a.typedInput("types",t)})),o.trigger("change"),a.on("change",(function(){$(this).val()&&l.show()})),l.on("click",(e=>{a.typedInput("type","str"),a.typedInput("value",""),$(e.currentTarget).hide()})),a.val()||l.hide()},Zt={category:Ge.HomeAssistant,color:We.HaBlue,inputs:1,outputs:1,outputLabels:function(e){if(this.halt_if){if(0===e)return"'If State' is true";if(1===e)return"'If State' is false"}},icon:"ha-current-state.svg",paletteLabel:"current state",label:function(){return this.name||`current_state: ${this.entity_id}`},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("apiCurrentStateVersion",0)},outputs:{value:1},halt_if:{value:""},halt_if_type:{value:"str"},halt_if_compare:{value:"is"},entity_id:{value:""},state_type:{value:"str"},blockInputOverrides:{value:!1},outputProperties:{value:[{property:"payload",propertyType:"msg",value:"",valueType:"entityState"},{property:"data",propertyType:"msg",value:"",valueType:"entity"}],validate:qe},for:{value:"0"},forType:{value:"num"},forUnits:{value:"minutes"},override_topic:{value:!1},state_location:{value:"payload"},override_payload:{value:"msg"},entity_location:{value:"data"},override_data:{value:"msg"}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),Jt({root:"#node-input-entity_id"}),Kt("#node-input-halt_if","#node-input-halt_if_type","#node-input-halt_if_compare","currentState"),$("#node-input-halt_if_compare").on("change",(function(){const e=["is","is_not","includes","does_not_include"].includes(this.value);$("#for-row").toggle(e)})),$("#node-input-for").typedInput({default:"num",types:["num","jsonata","msg","flow","global"],typeField:"#node-input-forType"}),Ve(this.outputProperties,{extraTypes:["entity","entityId","entityState"]})},oneditsave:function(){const e=$("#node-input-halt_if").val()?2:1;$("#node-input-outputs").val(e),this.outputProperties=Fe()}};function Xt(e,t,n,i){return new(n||(n=Promise))((function(a,o){function s(e){try{l(i.next(e))}catch(e){o(e)}}function r(e){try{l(i.throw(e))}catch(e){o(e)}}function l(e){var t;e.done?a(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(s,r)}l((i=i.apply(e,t||[])).next())}))}function Yt(e,t,n,i){if("a"===n&&!i)throw new TypeError("Private accessor was defined without a getter");if("function"==typeof t?e!==t||!i:!t.has(e))throw new TypeError("Cannot read private member from an object whose class did not declare it");return"m"===n?i:"a"===n?i.call(e):i?i.value:t.get(e)}function Qt(e,t,n,i,a){if("m"===i)throw new TypeError("Private method is not writable");if("a"===i&&!a)throw new TypeError("Private accessor was defined without a setter");if("function"==typeof t?e!==t||!a:!t.has(e))throw new TypeError("Cannot write private member to an object whose class did not declare it");return"a"===i?a.call(e,n):a?a.value=n:t.set(e,n),n}"function"==typeof SuppressedError&&SuppressedError;var en=Object.freeze({__proto__:null,getCapabilitiesList:e=>Xt(void 0,void 0,void 0,(function*(){return yield nt("deviceActionCapabilities",{action:e})})),getEventList:e=>Xt(void 0,void 0,void 0,(function*(){return yield nt("deviceActions",{deviceId:e})})),inputCount:1,setDefaultOutputs:()=>[]});var tn=Object.freeze({__proto__:null,getCapabilitiesList:e=>Xt(void 0,void 0,void 0,(function*(){return yield nt("deviceTriggerCapabilities",{trigger:e})})),getEventList:e=>Xt(void 0,void 0,void 0,(function*(){return yield nt("deviceTriggers",{deviceId:e})})),inputCount:0,setDefaultOutputs:e=>e});function nn(e=[],t=[]){const n=[];return e.forEach((e=>{const i=t.find((t=>t.name===e.name));switch(e.type){case"boolean":{const t=function(e,t){const n=`deviceExtra-${e.name}`,i=t?t.value:"",a=`\n        <label for="${n}">${e.name}</label>\n        <input type="checkbox" id="${n}" style="width: auto" value="${i}"/>        \n        `;return an(a)}(e,i);n.push($(t));break}case"float":{const t=function(e,t){const n=`deviceExtra-${e.name}`,i=t?t.value:"";let a=`\n        <label for="${n}">${e.name}</label>\n        <input type="text" id="${n}" style="width: 35%" value="${i}"/>        \n        `;e.description&&e.description.suffix&&(a+=`<span>${e.description.suffix}</span>`);return an(a)}(e,i);n.push($(t));break}case"integer":{const t=function(e,t){var n;const i=`deviceExtra-${e.name}`,a=t?t.value:"",o=$(`\n        <label for="${i}">${e.name}</label>\n        <div class="range-row">\n            <input type="checkbox" />\n            <input type="range" id="${i}" max="${e.valueMax}" min="${null!==(n=e.valueMin)&&void 0!==n?n:0}" value="${a}" />\n            <input type="text" value="${a}" />\n        </div>\n        `),s=o.find('input[type="checkbox"]'),r=o.find('input[type="range"]'),l=o.find('input[type="text"]');!1!==e.optional&&void 0===(null==t?void 0:t.value)||s.prop("checked",!0);!1===e.optional&&s.hide();return s.on("change",(()=>{r.prop("disabled",!s.prop("checked")).trigger("change"),l.prop("disabled",!s.prop("checked"))})).trigger("change"),r.on("change input",(()=>{l.val(r.val())})).trigger("change"),l.on("keyup change",(()=>{const t=l.val();if(t.length>0){const n=Number(t);n<e.valueMin&&l.val(e.valueMin),n>e.valueMax&&l.val(e.valueMax),r.val(l.val())}})),an(o)}(e,i);n.push(t);break}case"positive_time_period_dict":{const t=function(e,t){const n=`deviceExtra-${e.name}`,i=t?t.value:"",a=e=>t&&e===t.unit?"selected":"",o="ha-device.label",s={seconds:p(`${o}.seconds`),minutes:p(`${o}.minutes`),hours:p(`${o}.hours`)},r=`\n        <label for="${n}">\n            <i class="fa fa-clock-o"></i> ${e.name}\n        </label>\n        <input type="text" id="${n}" style="width: 35%" value="${i}"/>\n        <select id="${n}Units" style="width: 35%">\n            <option value="seconds" ${a("seconds")}>${s.seconds}</option>\n            <option value="minutes" ${a("minutes")}>${s.minutes}</option>\n            <option value="hours" ${a("hours")}>${s.hours}</option>\n        </select>`;return an(r)}(e,i);n.push($(t));break}case"select":{const t=function(e,t={}){const n=`deviceExtra-${e.name}`,i=e.options.reduce(((e,[n,i])=>{const a=t.value===n?"selected":"";return e.push(`<option value="${n}" ${a}>${i}</option>`),e}),[]),a=`\n        <label for="${n}">${e.name}</label>\n        <select id="${n}" style="width: 70%">\n        ${i.join("")}\n        </select>        \n        `;return an(a)}(e,i);n.push($(t));break}case"string":{const t=function(e,t){const n=`deviceExtra-${e.name}`,i=t?t.value:"",a=`\n        <label for="${n}">${e.name}</label>\n        <input type="text" id="${n}" style="width: 70%" value="${i}"/>\n        `;return an(a)}(e,i);n.push($(t));break}default:{const t=function(e,t={}){const n=`<label class="error"><i class="fa fa-exclamation-triangle"></i> Error</label>${e} -- <a href="https://github.com/zachowj/node-red-contrib-home-assistant-websocket/issues/new?title=[Device Node] Unknown extra type: ${t.type}" target="_blank"> ${p("ha-device.error.report")}</a>`;return an(n)}(p("ha-device.error.unknown_field_type",{type:e.type}),{type:e.type});n.push($(t))}}})),n}function an(e,t=["deviceExtra"]){return e instanceof $?$(`<div class="form-row ${t.join(" ")}"></div>`).append(e):`<div class="form-row ${t.join(" ")}">${e}</div>`}const on=e=>"action"===e?en:tn,sn=[{property:"payload",propertyType:"msg",value:"",valueType:"eventData"},{property:"topic",propertyType:"msg",value:"",valueType:"triggerId"}],rn={category:Ge.HomeAssistant,color:We.Alpha,inputs:0,outputs:1,icon:"font-awesome/fa-cube",paletteLabel:"device",label:function(){return this.name||`device ${this.deviceType}`},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haDeviceVersion",0)},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},inputs:{value:0},deviceType:{value:"trigger"},device:{value:""},event:{value:void 0,validate:e=>void 0!==e},capabilities:{value:[],validate:e=>{if(!Array.isArray(e))return!0;for(const t of e)switch(t.type){case"float":if(!Number.isFinite(Number(t.value)))return!1;break;case"positive_time_period_dict":if(-1===Math.sign(t.value))return!1;break}return!0}},outputProperties:{value:sn,validate:qe},exposeToHomeAssistant:{value:void 0},haConfig:{value:void 0}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),A(this);const e="_ADD_",t=$("#node-input-server"),n=$("#node-input-deviceType"),i=$("#node-input-device"),o=$("#event");let s,r=on(n.val());ct(a.Switch,"exposeAsEntityConfig"),i.on("select2:select",(function(){_($(this).val())})),o.on("change",(function(e){const t=e.target.value;if("__NONE__"===t)return;const n=o.data("events");w(n[t])}));const l=(e,t)=>{const n=c("text",e),i=c("text",t);return n===i?0:"string"!=typeof n?1:n.localeCompare(i)},u=()=>{b(),T()},v=()=>Xt(this,void 0,void 0,(function*(){const e=RED.i18n.lang();try{s=yield nt("translations",{cat:"device_automation",lang:e})}catch(e){RED.notify("Error retrieving translations.","error")}})),y=(e,t)=>{if(t&&(null==e?void 0:e.length)){const n=e.find((e=>e.area_id===t));if(n)return n.name}return p("ha-device.ui.no_area")},g=n=>{const a=t.val();if(a===e)return;const o=E(a);if(!o)return;const s=S(a);i.empty(),i.select2(Object.assign(Object.assign({},$t),{data:o.map((e=>({id:e.id,text:e.name_by_user||e.name,selected:e.id===n,title:y(s,e.area_id)}))).sort(l)})).maximizeSelect2Height()},h=()=>Xt(this,void 0,void 0,(function*(){u(),t.val()!==e&&(v(),g(),_(i.val()))})),f=e=>{const t=i.val(),n=e.target.value;var a;T(),t&&(r=on(n),_(t)),a=I(n),Be=a;const o="trigger"===n?sn:[],s=r.setDefaultOutputs(o);var l;l=s,Le.editableList("empty"),Le.editableList("addItems",l),$("#event").prev().text(n),$("#node-input-exposeAsEntityConfig").closest("div.form-row").toggle("trigger"===n)};t.one("change",(()=>{u(),g(this.device),t.val()!==e&&(v(),_(this.device,this.event,this.capabilities)),setTimeout((()=>{t.on("change",h),n.on("change",f)}),100)}));const b=()=>{o.html(`<option value="__NONE__">No ${n.val()}s</option>`).trigger("change").prop("disabled",!0)},T=()=>{$(".deviceExtra").remove()},_=(e,t,a)=>Xt(this,void 0,void 0,(function*(){if(!e)return;const s=yield r.getEventList(e);let l;if(0===s.length)b(),T(),l=0;else{if(s[0].device_id!==i.val())return;const e=n.val();o.data("events",s).empty().prop("disabled",!1);const r=[];for(let t=0;t<s.length;t++){const n=yield D(e,s[t]);r.push(new Option(n,t.toString()))}o.append(r),l=s.findIndex((e=>d(t,e))),l=-1===l?0:l,w(s[l],a)}$("option",o).eq(l).prop("selected",!0)})),w=(e,t)=>Xt(this,void 0,void 0,(function*(){T();const n=yield r.getCapabilitiesList(e);if(null==n?void 0:n.length){o.data("capabilities",n);const e=nn(n,t);o.parent().after(e)}})),D=(e,n)=>Xt(this,void 0,void 0,(function*(){var i;const a=(t="type")=>`component.${n.domain}.device_automation.${e}_${t}.${n[t]}`;let o=null!==(i=null==s?void 0:s[a()])&&void 0!==i?i:n.subtype?`"${n.subtype}" ${n.type}`:n.type;const r={entity_name:()=>Xt(this,void 0,void 0,(function*(){if(!n.entity_id)return"<unknown>";const e=function(e,t){return m[e][t]}(t.val(),n.entity_id);return e?e.attributes&&void 0!==e.attributes.friendly_name?e.attributes.friendly_name||"":n.entity_id.split(".")[1].replace(/_/g," "):""})),subtype:()=>s[a("subtype")]||n.subtype},l=Object.keys(r);for(const e of l){const t=`{${e}}`;if(-1!==o.indexOf(t)){const n=yield r[e]();o=o.replace(t,n)}}return o})),I=e=>({action:["sentData"],trigger:["eventData","triggerId"]}[e]);$("#dialog-form").prepend(ze.alphaWarning(367)),Ve(this.outputProperties,{extraTypes:I(n.val())})},oneditsave:function(){const e=on($("#node-input-deviceType").val()),t=$("#event"),n=t.val();if(this.inputs=e.inputCount,"__NONE__"!==n){const e=t.data("events"),i=t.data("capabilities");this.event=e[n],this.capabilities=function(e=[]){return e.reduce(((e,t)=>{const n=`deviceExtra-${t.name}`,i=$(`#${n}`).val();switch(t.type){case"boolean":e.push({name:t.name,type:t.type,value:$(`#${n}`).is(":checked")});break;case"float":case"positive_time_period_dict":if(i&&i.length&&!isNaN(Number(i))){const a={name:t.name,type:t.type,value:Number(i),unit:"positive_time_period_dict"===t.type?$(`#${n}Units`).val():void 0};e.push(a)}break;case"integer":if($(`#${n}`).siblings('input[type="checkbox"]').prop("checked")&&i&&i.length&&!isNaN(Number(i))){const n={name:t.name,type:t.type,value:Number(i)};e.push(n)}break;case"select":i&&i.length&&e.push({name:t.name,type:t.type,value:i});break;case"string":i.length&&e.push({name:t.name,type:t.type,value:i})}return e}),[])}(i)}this.outputProperties=Fe()}},ln={category:Ge.Config,defaults:{version:{value:RED.settings.get("haDeviceConfigVersion",0)},name:{value:"",required:!1},hwVersion:{value:"",required:!1},manufacturer:{value:"Node-RED",required:!1},model:{value:"",required:!1},swVersion:{value:"",required:!1}},icon:"font-awesome/fa-device",label:function(){return this.name||"Device Config"},oneditprepare:function(){ze.setup(this)}},un={category:Ge.HomeAssistantDeprecated,color:We.Deprecated,inputs:1,outputs:1,icon:function(){return"switch"===(null==this?void 0:this.entityType)?"ha-entity-switch.svg":"font-awesome/fa-genderless"},align:"right",paletteLabel:"entity",label:function(){return this.name||`type: ${this.entityType}`},labelStyle:function(){return this.name?"node_label_italic":""},defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haEntityVersion",0)},debugenabled:{value:!1},outputs:{value:1},entityType:{value:"sensor"},config:{value:[{property:"name",value:""},{property:"device_class",value:""},{property:"icon",value:""},{property:"unit_of_measurement",value:""},{property:"state_class",value:""},{property:"last_reset",value:""}]},state:{value:"payload"},stateType:{value:"msg"},attributes:{value:[]},resend:{value:!0},outputLocation:{value:"payload"},outputLocationType:{value:"none"},inputOverride:{value:"allow"},outputOnStateChange:{value:null},outputPayload:{value:null},outputPayloadType:{value:null}},oneditprepare:function(){ze.setup(this),this.server&&RED.tray.close()}};var pn,dn=[{id:"entity_category",type:"select",values:["","config","diagnostic"]},{id:"device_class",type:"select",values:["","battery","battery_charging","co","cold","connectivity","door","garage_door","gas","heat","light","lock","moisture","motion","moving","occupancy","opening","plug","power","presence","problem","running","safety","smoke","sound","tamper","update","vibration","window"]}];!function(e){e.ApparentPower="apparent_power",e.Aqi="aqi",e.AtmosphericPressure="atmospheric_pressure",e.Battery="battery",e.CarbonDioxide="carbon_dioxide",e.CarbonMonoxide="carbon_monoxide",e.Current="current",e.DataRate="data_rate",e.DataSize="data_size",e.Date="date",e.Distance="distance",e.Duration="duration",e.Energy="energy",e.EnergyStorage="energy_storage",e.Enum="enum",e.Frequency="frequency",e.Gas="gas",e.Humidity="humidity",e.Illuminance="illuminance",e.Irradiance="irradiance",e.Moisture="moisture",e.Monetary="monetary",e.NitrogenDioxide="nitrogen_dioxide",e.NitrogenMonoxide="nitrogen_monoxide",e.NitrousOxide="nitrous_oxide",e.Ozone="ozone",e.Pm1="pm1",e.Pm10="pm10",e.Pm25="pm25",e.Power="power",e.PowerFactor="power_factor",e.Precipitation="precipitation",e.PrecipitationIntensity="precipitation_intensity",e.Pressure="pressure",e.ReactivePower="reactive_power",e.SignalStrength="signal_strength",e.SoundPressure="sound_pressure",e.Speed="speed",e.SulphurDioxide="sulphur_dioxide",e.Temperature="temperature",e.Timestamp="timestamp",e.VolatileOrganicCompounds="volatile_organic_compounds",e.Voltage="voltage",e.Volume="volume",e.VolumeStorage="volume_storage",e.Water="water",e.Weight="weight",e.WindSpeed="wind_speed"}(pn||(pn={}));const cn=["AED","AFN","ALL","AMD","ANG","AOA","ARS","AUD","AWG","AZN","BAM","BBD","BDT","BGN","BHD","BIF","BMD","BND","BOB","BOV","BRL","BSD","BTN","BWP","BYN","BZD","CAD","CDF","CHE","CHF","CHW","CLF","CLP","COP","COU","CRC","CUC","CUP","CVE","CZK","DJF","DKK","DOP","DZD","EGP","ERN","ETB","EUR","FJD","FKP","GBP","GEL","GHS","GIP","GMD","GNF","GTQ","GYD","HKD","HNL","HRK","HTG","HUF","IDR","ILS","INR","IQD","IRR","ISK","JMD","JOD","JPY","KES","KGS","KHR","KMF","KPW","KRW","KWD","KYD","KZT","LAK","LBP","LKR","LRD","LSL","LYD","MAD","MDL","MGA","MKD","MMK","MNT","MOP","MRU","MUR","MVR","MWK","MXN","MXV","MYR","MZN","NAD","NGN","NIO","NOK","NPR","NZD","OMR","PAB","PEN","PGK","PHP","PKR","PLN","PYG","QAR","RON","RSD","CNY","RUB","RWF","SAR","SBD","SCR","SDG","SEK","SGD","SHP","SLL","SOS","SRD","SSP","STN","SVC","SYP","SZL","THB","TJS","TMT","TND","TOP","TRY","TTD","TWD","TZS","UAH","UGX","USD","USN","UYI","UYU","UYW","UZS","VED","VES","VND","VUV","WST","XAF","XAG","XAU","XBA","XBB","XBC","XBD","XCD","XDR","XOF","XPD","XPF","XPT","XSU","XTS","XUA","XXX","YER","ZAR","ZMW","ZWL"];var vn=[{id:"entity_category",type:"select",values:["","config","diagnostic"]},{id:"device_class",type:"select",values:["",...[pn.ApparentPower,pn.Aqi,pn.AtmosphericPressure,pn.Battery,pn.CarbonDioxide,pn.CarbonMonoxide,pn.Current,pn.DataRate,pn.DataSize,pn.Distance,pn.Energy,pn.EnergyStorage,pn.Frequency,pn.Gas,pn.Humidity,pn.Illuminance,pn.Irradiance,pn.Moisture,pn.Monetary,pn.NitrogenDioxide,pn.NitrogenMonoxide,pn.NitrousOxide,pn.Ozone,pn.Pm1,pn.Pm10,pn.Pm25,pn.Power,pn.PowerFactor,pn.Precipitation,pn.PrecipitationIntensity,pn.Pressure,pn.ReactivePower,pn.SignalStrength,pn.SoundPressure,pn.Speed,pn.SulphurDioxide,pn.Temperature,pn.VolatileOrganicCompounds,pn.Voltage,pn.Volume,pn.VolumeStorage,pn.Water,pn.Weight,pn.WindSpeed]]},{id:"unit_of_measurement",type:"unit_of_measurement",values:{apparent_power:["VA"],aqi:null,atmospheric_pressure:["cbar","bar","hPa","inHg","kPa","mbar","Pa","psi"],battery:["%"],carbon_dioxide:["ppm"],carbon_monoxide:["ppm"],current:["A"],data_rate:["bit/s","kbit/s","Mbit/s","Gbit/s","B/s","kB/s","MB/s","GB/s","KiB/s","MiB/s","GiB/s"],data_size:["bit","kbit","Mbit","Gbit","B","kB","MB","GB","TB","PB","EB","ZB","YB","KiB","MiB","GiB","TiB","PiB","EiB","ZiB","YiB"],distance:["km","m","cm","mm","mi","yd","in"],energy:["Wh","kWh","MWh","GJ"],energy_storage:["Wh","kWh","MWh","MJ","GJ"],frequency:["Hz","kHz","MHz","GHz"],gas:["m³","ft³"],humidity:["%"],illuminance:["lx","lm"],irradiance:["W/m²","BTU/(h*ft²)"],moisture:["%"],monetary:cn,nitrogen_dioxide:["µg/m³"],nitrogen_monoxide:["µg/m³"],nitrous_oxide:["µg/m³"],ozone:["µg/m³"],pm1:["µg/m³"],pm25:["µg/m³"],pm10:["µg/m³"],power:["W","kW"],power_factor:["%"],precipitation:["mm","in","cm"],precipitation_intensity:["mm/h","mm/d","in/h","in/d"],pressure:["cbar","bar","hPa","inHg","kPa","mbar","Pa","psi"],reactive_power:["var"],signal_strength:["dB","dBm"],sound_pressure:["dB","dBA"],speed:["ft/s","in/d","in/h","km/h","kn","m/s","mm/d","mph"],sulphur_dioxide:["µg/m³"],temperature:["°C","°F"],volatile_organic_compounds:["µg/m³"],voltage:["V"],volume:["fl. oz.","ft³","gal","L","mL","m³"],volume_storage:["L","mL","gal","fl. oz.","m³","ft³","CCF"],water:["L","gal","m³","ft³"],weight:["g","kg","lb","mg","oz","µg"],wind_speed:["ft/s","km/h","kn","m/s","mph"]}},{id:"min_value",type:"number"},{id:"max_value",type:"number"},{id:"step_value",type:"number"},{id:"mode",type:"select",values:["auto","box","slider"]}];var yn=[{id:"entity_category",type:"select",values:["","diagnostic"]},{id:"device_class",type:"select",values:["",...[pn.ApparentPower,pn.Aqi,pn.AtmosphericPressure,pn.Battery,pn.CarbonDioxide,pn.CarbonMonoxide,pn.Current,pn.DataRate,pn.DataSize,pn.Date,pn.Distance,pn.Duration,pn.Energy,pn.EnergyStorage,pn.Enum,pn.Frequency,pn.Gas,pn.Humidity,pn.Illuminance,pn.Irradiance,pn.Moisture,pn.Monetary,pn.NitrogenDioxide,pn.NitrogenMonoxide,pn.NitrousOxide,pn.Ozone,pn.Pm1,pn.Pm10,pn.Pm25,pn.Power,pn.PowerFactor,pn.Precipitation,pn.PrecipitationIntensity,pn.Pressure,pn.ReactivePower,pn.SignalStrength,pn.SoundPressure,pn.Speed,pn.SulphurDioxide,pn.Temperature,pn.Timestamp,pn.VolatileOrganicCompounds,pn.Voltage,pn.Volume,pn.VolumeStorage,pn.Water,pn.Weight,pn.WindSpeed]]},{id:"unit_of_measurement",type:"unit_of_measurement",values:{apparent_power:["VA"],aqi:null,atmospheric_pressure:["cbar","bar","hPa","inHg","kPa","mbar","Pa","psi"],battery:["%"],carbon_dioxide:["ppm"],carbon_monoxide:["ppm"],current:["A"],data_rate:["bit/s","kbit/s","Mbit/s","Gbit/s","B/s","kB/s","MB/s","GB/s","KiB/s","MiB/s","GiB/s"],data_size:["bit","kbit","Mbit","Gbit","B","kB","MB","GB","TB","PB","EB","ZB","YB","KiB","MiB","GiB","TiB","PiB","EiB","ZiB","YiB"],date:null,distance:["km","m","cm","mm","mi","yd","in"],duration:["d","h","min","s"],energy:["Wh","kWh","MWh","GJ"],energy_storage:["Wh","kWh","MWh","MJ","GJ"],enum:null,frequency:["Hz","kHz","MHz","GHz"],gas:["m³","ft³"],humidity:["%"],illuminance:["lx","lm"],irradiance:["W/m²","BTU/(h*ft²)"],moisture:["%"],monetary:cn,nitrogen_dioxide:["µg/m³"],nitrogen_monoxide:["µg/m³"],nitrous_oxide:["µg/m³"],ozone:["µg/m³"],pm1:["µg/m³"],pm25:["µg/m³"],pm10:["µg/m³"],power:["W","kW"],power_factor:["%"],precipitation:["mm","in","cm"],precipitation_intensity:["mm/h","mm/d","in/h","in/d"],pressure:["cbar","bar","hPa","inHg","kPa","mbar","Pa","psi"],reactive_power:["var"],signal_strength:["dB","dBm"],sound_pressure:["dB","dBA"],speed:["ft/s","in/d","in/h","km/h","kn","m/s","mm/d","mph"],sulphur_dioxide:["µg/m³"],temperature:["°C","°F"],timestamp:null,volatile_organic_compounds:["µg/m³"],voltage:["V"],volume:["fl. oz.","ft³","gal","L","mL","m³"],volume_storage:["L","mL","gal","fl. oz.","m³","ft³","CCF"],water:["L","gal","m³","ft³"],weight:["g","kg","lb","mg","oz","µg"],wind_speed:["ft/s","km/h","kn","m/s","mph"]}},{id:"state_class",type:"select",values:["","measurement","total","total_increasing"]},{id:"last_reset",type:"datetime"}];const gn=[{id:"name",type:"string"},{id:"icon",type:"string"},{id:"entity_picture",type:"string"}],hn={button:[{id:"entity_category",type:"select",values:["","config","diagnostic"]},{id:"device_class",type:"select",values:["","restart","update"]}],binary_sensor:dn,number:vn,select:[{id:"entity_category",type:"select",values:["","config","diagnostic"]},{id:"options",type:"editableList",values:["option1"]}],sensor:yn,switch:[{id:"entity_category",type:"select",values:["","config","diagnostic"]},{id:"device_class",type:"select",values:["","outlet","switch"]}],text:[{id:"entity_category",type:"select",values:["","config","diagnostic"]},{id:"mode",type:"select",values:["text","password"]},{id:"min_length",type:"number"},{id:"max_length",type:"number"},{id:"pattern",type:"string"}]},mn={binary_sensor:["resend"],sensor:["resend"]},fn={category:Ge.Config,defaults:{server:{value:"",type:s.Server,required:!0},deviceConfig:{value:"",type:s.DeviceConfig,required:!1},name:{value:""},version:{value:RED.settings.get("haEntityConfigVersion",0)},entityType:{value:"binary_sensor",required:!0},haConfig:{value:[],validate:function(e){if("select"===$("#node-config-input-entityType").val()){const t=e.find((e=>"options"===e.property));if(!t||!Array.isArray(t.value)||!t.value.length)return!1}return!0}},resend:{value:!1},debugEnabled:{value:!1}},label:function(){return this.name||`${this.entityType} ${this.id}`},oneditprepare:function(){ze.setup(this),this.deviceConfig||$("#node-config-input-deviceConfig").val("_ADD_"),(()=>{const e=$("body").data("haEntityType");e&&($("#node-config-input-entityType").val(e),$("body").data("haEntityType",null))})();const e=$("#ha-config-rows"),t=this;$("#node-config-input-entityType").on("change",(function(){var n;const i=$(this).val();$(".ha-config-row").remove(),$("#node-config-dialog-edit-form .ha-optional-row").each((function(){var e;const t=$(this),n=t.attr("id");n&&t.hasClass("ha-optional-row")&&t.toggle(null===(e=mn[i])||void 0===e?void 0:e.includes(n.replace(/-row$/,"")))}));const o=[...gn,...null!==(n=hn[i])&&void 0!==n?n:[]];o.forEach((n=>{var i,a;const o=null!==(a=null===(i=t.haConfig.find((e=>e.property===n.id)))||void 0===i?void 0:i.value)&&void 0!==a?a:"";e.append(dt(o,n))})),i!==a.Number&&i!==a.Sensor||$("#ha-config-device_class").on("change",(function(){var e,n,i,a;const s=null!==(n=null===(e=t.haConfig.find((e=>"unit_of_measurement"===e.property)))||void 0===e?void 0:e.value)&&void 0!==n?n:"",r=null!==(a=null===(i=o.find((e=>"unit_of_measurement"===e.id)))||void 0===i?void 0:i.values)&&void 0!==a?a:[];$("#ha-config-unit_of_measurement").parent().replaceWith(dt(s,{id:"unit_of_measurement",type:"unit_of_measurement",values:r}))}))}))},oneditsave:function(){const e=[];$(".ha-config-row").each((function(){const t=$(this);switch(t.data("type")){case"datetime":case"date":{const n=t.find("input").data("property"),i=t.find("input").val();if(""===i)return;const a=new Date(i);e.push({property:n,value:a.toISOString()});break}case"editableList":{const n=t.find("ol").editableList("items"),i=[];n.each((function(){const e=$(this).find("input");i.push(e.val())})),e.push({property:"options",value:i});break}case"number":{const n=t.find("input").data("property"),i=t.find("input").val(),a=i.length?Number(i):"";e.push({property:n,value:a});break}case"string":{const n=t.find("input").data("property"),i=t.find("input").val();e.push({property:n,value:i});break}case"select":{const n=t.find("select"),i=n.data("property"),a=n.val();e.push({property:i,value:a});break}case"unit_of_measurement":{const n=t.find("select, input"),i=n.data("property"),a=n.val();e.push({property:i,value:a});break}}})),this.haConfig=e}},bn={category:Ge.HomeAssistant,color:We.HaBlue,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("serverEventsVersion",0)},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},eventType:{value:"",required:!1},eventData:{value:"",validate:RED.validators.typedInput({allowBlank:!0})},waitForRunning:{value:!0},outputProperties:{value:[{property:"payload",propertyType:"msg",value:"",valueType:"eventData"},{property:"topic",propertyType:"msg",value:'$outputData("eventData").event_type',valueType:"jsonata"}],validate:qe},event_type:{value:void 0},exposeToHomeAssistant:{value:void 0},haConfig:{value:void 0}},inputs:0,outputs:1,icon:"ha-events-all.svg",paletteLabel:"events: all",label:function(){return this.name||`events: ${this.eventType||"all"}`},labelStyle:ze.labelStyle,oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),A(this),ct(a.Switch,"exposeAsEntityConfig"),$("#node-input-eventData").typedInput({types:["json"]}),$("#node-input-eventType").on("change input",(function(){const e=$(this).val().trim();$("#eventAlert").toggle(0===e.length),this.value=e})),Ve(this.outputProperties,{extraTypes:["eventData"]})},oneditsave:function(){this.outputProperties=Fe()}},Tn={category:Ge.HomeAssistant,color:We.Beta,inputs:0,outputs:1,outputLabels:["Calendar event triggered"],icon:"ha-events-calendar.svg",paletteLabel:"events: calendar",label:function(){return this.name||"calendar_event"},labelStyle:ze.labelStyle,defaults:{name:{value:""},version:{value:RED.settings.get("eventsCalendarVersion",0)},server:{value:"",type:s.Server,required:!0},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},entityId:{value:"",required:!0},filter:{value:""},filterType:{value:"str",required:!0},eventType:{value:"start",required:!0},offset:{value:0,required:!0},offsetType:{value:"num",required:!0},offsetUnits:{value:"minutes",required:!0},outputProperties:{value:[{property:"payload",propertyType:l.Message,value:"",valueType:"calendarItem"}],validate:qe}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),A(this),ct(a.Switch,"exposeAsEntityConfig"),$("#dialog-form").prepend(ze.betaWarning(1295)),Jt({root:"#node-input-entityId",options:{type:"calendars"}}),$("#node-input-offset").typedInput({default:"num",types:["num","jsonata"],typeField:"#node-input-offsetType"}),$("#node-input-filter").typedInput({types:["str","jsonata"],typeField:"#node-input-filterType"}),Ve(this.outputProperties,{extraTypes:["calendarItem"]})},oneditsave:function(){this.outputProperties=Fe()}};var $n,_n,Sn,En,wn,Dn,In,xn,On,Cn,jn,kn;!function(e){e.Boolean="bool",e.Home_Assistant_Boolean="habool",e.List="list",e.Number="num",e.Regexp="re",e.String="str"}($n||($n={}));class Pn{constructor({filterTypeSelector:e,entityId:t,serverId:n}){_n.add(this),Sn.set(this,void 0),En.set(this,void 0),wn.set(this,void 0),Dn.set(this,void 0),In.set(this,void 0),xn.set(this,void 0),Qt(this,wn,$(e),"f"),Qt(this,In,t,"f"),Qt(this,xn,n,"f"),Yt(this,_n,"m",Cn).call(this),this.init()}get entityId(){var e,t,n,i;let a=[];switch(Yt(this,wn,"f").val()){case"exact":a=Et(Yt(this,Sn,"f"))?null===(t=null===(e=Yt(this,Sn,"f").select2("data"))||void 0===e?void 0:e[0])||void 0===t?void 0:t.id:"";break;case"list":a=Et(Yt(this,Sn,"f"))?null!==(i=null===(n=Yt(this,Sn,"f").select2("data"))||void 0===n?void 0:n.map((e=>e.id)))&&void 0!==i?i:[]:"";break;case"substring":case"regex":a=Yt(this,En,"f").val()}return a}init(){Yt(this,wn,"f").on("change",Yt(this,_n,"m",jn).bind(this)),Yt(this,Dn,"f").on("click",(()=>{(({filter:e,filterType:t,entities:n,complete:i})=>{RED.editor.showTypeEditor("ha_entity_filter",{filter:e,filterType:t,entities:n,complete:i})})({filter:Yt(this,En,"f").val(),filterType:Yt(this,wn,"f").val(),entities:at(),complete:e=>{Yt(this,En,"f").val(e)}})})),Yt(this,_n,"m",kn).call(this,Array.isArray(Yt(this,In,"f"))),Yt(this,En,"f").val(Yt(this,In,"f"))}destroy(){Et(Yt(this,Sn,"f"))&&Yt(this,Sn,"f").select2("destroy")}serverChanged(e){Qt(this,xn,e,"f"),Yt(this,Sn,"f").empty(),Yt(this,_n,"m",jn).call(this)}}Sn=new WeakMap,En=new WeakMap,wn=new WeakMap,Dn=new WeakMap,In=new WeakMap,xn=new WeakMap,_n=new WeakSet,On=function(){const e=at(),t=(Array.isArray(Yt(this,In,"f"))?Yt(this,In,"f"):[Yt(this,In,"f")]).reduce(((t,n)=>{var i,a;const o="id"===rt().entitySelector?n:null!==(a=null===(i=e.find((e=>e.entity_id===n)))||void 0===i?void 0:i.attributes.friendly_name)&&void 0!==a?a:n;return t.push($("<option />",{value:n,text:o,selected:!0})),t}),[]);return t},Cn=function(){const e=Yt(this,wn,"f").parent(),t=$("<div />",{class:"ha-entity-selector"}),n=Yt(this,wn,"f").val();Qt(this,Sn,$("<select />",{id:"ha-entity-selector",multiple:"list"===n}),"f"),Qt(this,En,$("<input />",{type:"text"}),"f"),Qt(this,Dn,$('\n            <a class="editor-button">\n                <i class="fa fa-search"></i>\n            </a>'),"f"),e.append(t.append([Yt(this,Sn,"f"),Yt(this,En,"f"),Yt(this,Dn,"f")])),Yt(this,wn,"f").appendTo(t),""!==Yt(this,In,"f")&&Yt(this,Sn,"f").append(Yt(this,_n,"m",On).call(this))},jn=function(){const e=Yt(this,wn,"f").val();switch(e){case"exact":case"list":Yt(this,_n,"m",kn).call(this,"list"===e),Yt(this,Dn,"f").hide(),Yt(this,En,"f").hide();break;case"substring":case"regex":Yt(this,Sn,"f").next().hide(),Yt(this,Dn,"f").show(),Yt(this,En,"f").val(Yt(this,In,"f")).show()}},kn=function(e=!1){Yt(this,Sn,"f").select2(_t({tags:bt.Custom,multiple:e,displayIds:"id"===rt().entitySelector,ajax:{endpoint:Tt.Entities,serverId:Yt(this,xn,"f")}})).maximizeSelect2Height(),e&&y(Yt(this,Sn,"f"))};const Rn={category:Ge.HomeAssistant,color:We.HaBlue,inputs:0,outputs:1,outputLabels:["'If State' is true","'If State' is false"],icon:"ha-events-state-changed.svg",paletteLabel:"events: state",label:function(){return this.name||`state_changed: ${this.entityId||"all entities"}`},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("serverStateChangedVersion",0)},outputs:{value:1},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},entityId:{value:"",required:!0},entityIdType:{value:"exact"},outputInitially:{value:!1},stateType:{value:$n.String},ifState:{value:""},ifStateType:{value:l.String},ifStateOperator:{value:n.Is},outputOnlyOnStateChange:{value:!0},for:{value:"0"},forType:{value:"num"},forUnits:{value:"minutes"},ignorePrevStateNull:{value:!1},ignorePrevStateUnknown:{value:!1},ignorePrevStateUnavailable:{value:!1},ignoreCurrentStateUnknown:{value:!1},ignoreCurrentStateUnavailable:{value:!1},outputProperties:{value:[{property:"payload",propertyType:l.Message,value:"",valueType:"entityState"},{property:"data",propertyType:l.Message,value:"",valueType:"eventData"},{property:"topic",propertyType:l.Message,value:"",valueType:"triggerId"}],validate:qe},exposeToHomeAssistant:{value:void 0},haConfig:{value:void 0},entityidfilter:{value:void 0},entityidfiltertype:{value:void 0},outputinitially:{value:void 0},state_type:{value:void 0},haltifstate:{value:void 0},halt_if_type:{value:void 0},halt_if_compare:{value:void 0},output_only_on_state_change:{value:void 0}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server",(t=>{e.serverChanged(t)})),A(this),ct(a.Switch,"exposeAsEntityConfig");const e=new Pn({filterTypeSelector:"#node-input-entityIdType",entityId:this.entityId,serverId:Ye()});$("#dialog-form").data("entitySelector",e),Kt("#node-input-ifState","#node-input-ifStateType","#node-input-ifStateOperator"),$("#node-input-for").typedInput({default:"num",types:["num","jsonata","flow","global"],typeField:"#node-input-forType"}),Ve(this.outputProperties,{extraTypes:["eventData","entityId","entityState"]})},oneditsave:function(){const e=$("#node-input-ifState").val()?2:1;$("#node-input-outputs").val(e),this.outputProperties=Fe();const t=$("#dialog-form").data("entitySelector");this.entityId=t.entityId,t.destroy()},oneditcancel:function(){$("#dialog-form").data("entitySelector").destroy()}},An={category:Ge.HomeAssistant,color:We.HaBlue,inputs:1,outputs:1,icon:"ha-fire-event.svg",align:"right",paletteLabel:"fire event",label:function(){return this.name||`Event: ${this.event}`},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haFireEventVersion",0)},event:{value:""},data:{value:"",validate:RED.validators.typedInput({type:"dateType",allowBlank:!0})},dataType:{value:l.JSONata}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),$("#node-input-data").typedInput({types:[l.JSON,l.JSONata],typeField:"#node-input-dataType"})}};var Ln;!function(e){e.Array="array",e.Count="count",e.Random="random",e.Split="split"}(Ln||(Ln={}));const Bn={category:Ge.HomeAssistant,color:We.HaBlue,inputs:1,outputs:1,icon:"ha-get-entities.svg",paletteLabel:"get entities",label:function(){return this.name||"get entities"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haGetEntitiesVersion",0)},rules:{value:[{property:"",logic:"is",value:"",valueType:"str"}]},outputType:{value:Ln.Array},outputEmptyResults:{value:!1},outputLocationType:{value:"msg"},outputLocation:{value:"payload"},outputResultsCount:{value:1,validate:function(e){return $("#node-input-outputType").val()!==Ln.Random||Number.isInteger(Number(e))}},output_type:{value:void 0},output_empty_results:{value:void 0},output_location_type:{value:void 0},output_location:{value:void 0},output_results_count:{value:void 0}},oneditprepare:function(){ze.setup(this);const e=[{value:"is",text:"is"},{value:"is_not",text:"is not"},{value:"lt",text:"<"},{value:"lte",text:"<="},{value:"gt",text:">"},{value:"gte",text:">="},{value:"includes",text:"in"},{value:"does_not_include",text:"not in"},{value:"starts_with",text:"starts with"},{value:"in_group",text:"in group"},{value:"jsonata",text:"JSONata"}],t={value:"entity",label:"entity."},n=["str","num","bool","re","jsonata","msg","flow","global",t],i=$("#logic");let a=[];Xe(this,"#node-input-server"),Qe("properties",(e=>{a=e,$(".input-property").autocomplete({source:a,minLength:0})})),i.editableList({addButton:!0,removable:!0,height:"auto",addItem:function(i,o,s){const r=$("<div />",{class:"editable-list-row"}).appendTo(i),l=$("<div />",{class:"editable-list-row"}).appendTo(i);s.hasOwnProperty("logic")||(s.logic="is"),$("<span />",{text:"Property",style:"padding-right: 47px;"}).appendTo(r);const u=$("<input />",{type:"text",class:"input-property",style:"margin-left: 5px;"}).appendTo(r).val(s.property);u.autocomplete({source:a,minLength:0});const p=$("<select/>",{style:"margin-right: 5px;width: auto;"}).appendTo(l).on("change",(function(){const e=$(this).val();let i=n;switch(u.prop("disabled","jsonata"===e),e){case"is":case"is_not":break;case"lt":case"lte":case"gt":case"gte":i=["num","jsonata","msg","flow","global",t];break;case"includes":case"does_not_include":case"starts_with":case"in_group":i=["str","jsonata","msg","flow","global",t];break;case"jsonata":i=["jsonata"]}d.typedInput("types",i)}));for(const t in e)p.append($("<option></option>").val(e[t].value).text(e[t].text));const d=$("<input />",{class:"input-value",type:"text",style:"width: 70%;"}).appendTo(l).val(s.value);d.typedInput({types:n}),d.typedInput("type",s.valueType),p.val(s.logic).trigger("change")}}),i.editableList("addItems",this.rules),$("#node-input-outputLocation").typedInput({types:["msg","flow","global"],typeField:"#node-input-outputLocationType"}),$("#node-input-outputResultsCount").spinner({min:1}),$("#node-input-outputType").on("change",(function(){switch($(".output-option").hide(),$(this).val()){case Ln.Array:$("#output_empty_results").show(),$("#output_location").show();break;case Ln.Count:$("#output_location").show();break;case Ln.Random:$("#output_results_count").show(),$("#output_location").show();case Ln.Split:}})).trigger("change")},oneditsave:function(){const e=$("#logic").editableList("items");this.rules=[];const t=this;e.each((function(){var e,n,i;const a=$(this),o=null!==(e=a.find(".input-property").val())&&void 0!==e?e:"",s=null!==(n=a.find("select").val())&&void 0!==n?n:"",r=null!==(i=a.find(".input-value").typedInput("value"))&&void 0!==i?i:"",l=a.find(".input-value").typedInput("type");t.rules.push({property:o,logic:s,value:r,valueType:l})}))}};var Nn,Hn;!function(e){e.Array="array",e.Split="split"}(Nn||(Nn={})),function(e){e.Equals="equals",e.Regex="regex"}(Hn||(Hn={}));const Vn={category:Ge.HomeAssistant,color:We.HaBlue,inputs:1,outputs:1,icon:"ha-get-history.svg",paletteLabel:"get history",label:function(){if(this.name)return this.name;if(this.useRelativeTime&&this.relativeTime)return this.relativeTime;if(this.startDate){const e=new Date(this.startDate);return`${e.toLocaleDateString()} ${e.toLocaleTimeString()}`}return"get history"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("apiGetHistoryVersion",0)},startDate:{value:""},endDate:{value:""},entityId:{value:""},entityIdType:{value:Hn.Equals},useRelativeTime:{value:!0},relativeTime:{value:""},flatten:{value:!0},outputType:{value:Nn.Array},outputLocationType:{value:l.Message},outputLocation:{value:"payload"},startdate:{value:void 0},enddate:{value:void 0},entityid:{value:void 0},entityidtype:{value:void 0},output_type:{value:void 0},output_location_type:{value:void 0},output_location:{value:void 0}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),Jt({root:"#node-input-entityId"}),$("#node-input-useRelativeTime").on("change",(function(){this.checked?($(".relative_row").show(),$(".date_row").hide()):($(".relative_row").hide(),$(".date_row").show())})),$("#node-input-outputLocation").typedInput({types:[l.Message,l.Flow,l.Global],typeField:"#node-input-outputLocationType"}),$("#node-input-outputType").on("change",(e=>{const t=e.target;$(".output-option").toggle(t.value===Nn.Array)})).trigger("change")}},Mn={category:Ge.HomeAssistantEntities,color:We.Beta,inputs:0,outputs:1,icon:"font-awesome/fa-hashtag",align:"left",paletteLabel:"number",label:function(){return this.name||"number"},labelStyle:ze.labelStyle,defaults:{name:{value:""},version:{value:RED.settings.get("haNumberVersion",0)},debugenabled:{value:!1},inputs:{value:0},outputs:{value:1},entityConfig:{value:"",type:s.EntityConfig,filter:e=>"number"===e.entityType,required:!0},mode:{value:r.Listen},value:{value:"payload"},valueType:{value:l.Message},outputProperties:{value:[{property:"payload",propertyType:l.Message,value:"",valueType:l.Value},{property:"previousValue",propertyType:l.Message,value:"",valueType:l.PreviousValue}],validate:qe}},oneditprepare:function(){ze.setup(this),A(this),ct(a.Number),$("#dialog-form").prepend(ze.betaWarning(962));const e=$("#node-input-value").parent();$("#node-input-mode").on("change",(function(){e.toggle(this.value===r.Set),$("#node-input-inputs").val(this.value===r.Listen?0:1)})),$("#node-input-value").typedInput({types:[l.Message,l.Flow,l.Global,l.JSONata,l.Number],typeField:"#node-input-valueType",type:this.valueType}),Ve(this.outputProperties,{extraTypes:[l.Value,l.PreviousValue]})},oneditsave:function(){this.outputProperties=Fe()}},Fn={category:Ge.HomeAssistant,color:We.HaBlue,inputs:0,outputs:1,outputLabels:[p("poll-state.output_label.if_state_true"),p("poll-state.output_label.if_state_false")],icon:"ha-poll-state.svg",paletteLabel:"poll state",label:function(){return this.name||`poll state: ${this.entityId}`},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("pollStateVersion",0)},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},updateInterval:{value:"60"},updateIntervalType:{value:l.Number},updateIntervalUnits:{value:u.Seconds},outputInitially:{value:!1},outputOnChanged:{value:!1},entityId:{value:"",required:!0},stateType:{value:$n.String},ifState:{value:""},ifStateType:{value:l.String},ifStateOperator:{value:n.Is},outputs:{value:1},outputProperties:{value:[{property:"payload",propertyType:l.Message,value:"",valueType:"entityState"},{property:"data",propertyType:l.Message,value:"",valueType:"entity"},{property:"topic",propertyType:l.Message,value:"",valueType:"triggerId"}],validate:qe},exposeToHomeAssistant:{value:void 0},haConfig:{value:void 0},updateinterval:{value:void 0},outputinitially:{value:void 0},outputonchanged:{value:void 0},entity_id:{value:void 0},state_type:{value:void 0},halt_if:{value:void 0},halt_if_type:{value:void 0},halt_if_compare:{value:void 0}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),A(this),Jt({root:"#node-input-entityId"}),ct(a.Switch,"exposeAsEntityConfig"),$("#node-input-updateInterval").typedInput({types:[l.Number,l.JSONata],typeField:"#node-input-updateIntervalType"}),Kt("#node-input-ifState","#node-input-ifStateType","#node-input-ifStateOperator"),Ve(this.outputProperties,{extraTypes:["entity","entityId","entityState"]})},oneditsave:function(){const e=$("#node-input-ifState").val()?2:1;$("#node-input-outputs").val(e),this.outputProperties=Fe()}};let qn;const Gn={category:Ge.HomeAssistant,color:We.HaBlue,inputs:1,outputs:1,icon:"ha-render-template.svg",paletteLabel:"render template",label:function(){return this.name||"template"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("apiRenderTemplateVersion",0)},template:{value:""},resultsLocation:{value:"payload"},resultsLocationType:{value:l.Message},templateLocation:{value:""},templateLocationType:{value:l.None}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server");const e=$("#node-input-template");$("#node-input-templateLocation").typedInput({types:[l.Message,l.Flow,l.Global,{value:l.None,label:"none",hasValue:!1}],typeField:"#node-input-templateLocationType"}),$("#node-input-resultsLocation").typedInput({types:[l.Message,l.Flow,l.Global],typeField:"#node-input-resultsLocationType"}),qn=RED.editor.createEditor({id:"node-input-template-editor",mode:"ace/mode/text",value:e.val()})},oneditresize:function(){var e;const t=$("#dialog-form>div:not(.node-text-editor-row)"),n=$("#dialog-form>div.node-text-editor-row"),i=$(".node-text-editor");let a=null!==(e=$("#dialog-form").height())&&void 0!==e?e:0;for(let e=0;e<t.length;e++){const n=$(t[e]).outerHeight(!0);"number"==typeof n&&(a-=n)}a-=parseInt(n.css("marginTop"))+parseInt(n.css("marginBottom")),i.css("height",`${a}px`),null==qn||qn.resize()},oneditcancel:function(){null==qn||qn.destroy(),qn=void 0},oneditsave:function(){var e;const t=null!==(e=null==qn?void 0:qn.getValue())&&void 0!==e?e:"";$("#node-input-template").val(t),null==qn||qn.destroy(),qn=void 0}},Wn={category:Ge.HomeAssistantEntities,color:We.Beta,inputs:0,outputs:1,icon:"font-awesome/fa-list",align:"left",paletteLabel:"select",label:function(){return this.name||"select"},labelStyle:ze.labelStyle,defaults:{name:{value:""},version:{value:RED.settings.get("haTextVersion",0)},debugenabled:{value:!1},inputs:{value:0},outputs:{value:1},entityConfig:{value:"",type:s.EntityConfig,filter:e=>"select"===e.entityType,required:!0},mode:{value:r.Listen},value:{value:"payload"},valueType:{value:l.Message},outputProperties:{value:[{property:"payload",propertyType:l.Message,value:"",valueType:l.Value},{property:"previousValue",propertyType:l.Message,value:"",valueType:l.PreviousValue}],validate:qe}},oneditprepare:function(){ze.setup(this),A(this),ct(a.Select),$("#dialog-form").prepend(ze.betaWarning(968));const e=$("#node-input-value").parent();$("#node-input-mode").on("change",(function(){e.toggle(this.value===r.Set),$("#node-input-inputs").val(this.value===r.Listen?0:1)})),$("#node-input-value").typedInput({types:[l.Message,l.Flow,l.Global,l.JSONata,l.String],typeField:"#node-input-valueType",type:this.valueType}),Ve(this.outputProperties,{extraTypes:[l.Value,l.PreviousValue]})},oneditsave:function(){this.outputProperties=Fe()}},zn=["msg","flow","global","jsonata","str","num","bool"],Un=["str","num","bool","date","jsonata","msg","flow","global"],Jn={category:Ge.HomeAssistantEntities,color:We.HaBlue,inputs:1,outputs:1,icon:"font-awesome/fa-genderless",align:"right",paletteLabel:"sensor",label:function(){return this.name||"sensor"},labelStyle:ze.labelStyle,defaults:{name:{value:""},entityConfig:{value:"",type:s.EntityConfig,filter:e=>"sensor"===e.entityType,required:!0},version:{value:RED.settings.get("haSensorVersion",0)},state:{value:"payload"},stateType:{value:"msg"},attributes:{value:[]},inputOverride:{value:"allow"},outputProperties:{value:[],validate:qe}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),A(this);$("#node-input-state").typedInput({types:zn,typeField:"#node-input-stateType",type:this.stateType}),ct(a.Sensor),$("#attributes").editableList({removable:!0,addButton:"add attribute",header:$("<div>").append($.parseHTML("<div style='width:40%; display: inline-grid'>Attribute Key</div><div style='display: inline-grid'>Value</div>")),addItem:function(e,t,n){const i=$("<div />").appendTo(e);$("<input />",{type:"text",name:"property",style:"width: 40%;margin-right: 5px;"}).attr("autocomplete","disable").appendTo(i).val(n.property);const a=$("<input />",{type:"text",name:"value",style:"width: 55%;"}).appendTo(i).val(n.value);a.typedInput({types:Un}),a.typedInput("type",n.valueType)}}).editableList("addItems",this.attributes),Ve(this.outputProperties,{extraTypes:["sentData"]})},oneditsave:function(){this.attributes=[];const e=this;$("#attributes").editableList("items").each((function(){const t=$(this);e.attributes.push({property:t.find("input[name=property]").val(),value:t.find("input[name=value]").typedInput("value"),valueType:t.find("input[name=value]").typedInput("type")})})),this.outputProperties=Fe()}},Kn={category:Ge.HomeAssistant,color:We.Beta,outputs:1,outputLabels:"",icon:"font-awesome/fa-comment-o",paletteLabel:"sentence",label:function(){return this.name||"sentence"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haSentenceVersion",0)},outputs:{value:1},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},sentences:{value:[],validate:e=>e.length>0},response:{value:""},outputProperties:{value:[{property:"topic",propertyType:l.Message,value:"",valueType:l.TriggerId},{property:"payload",propertyType:l.Message,value:"",valueType:l.TriggerId}],validate:qe}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),A(this),ct(a.Switch,"exposeAsEntityConfig"),$("#dialog-form").prepend(ze.betaWarning(981)),$("#node-input-sentences-container").editableList({addButton:!0,removable:!0,height:"auto",header:$("<div>").append(this._("ha-sentence.label.sentences")),addItem:function(e,t,n){$("<input />",{type:"text",value:"string"==typeof n?n:"",style:"width: 100%"}).appendTo(e)}}).editableList("addItems",this.sentences.length?this.sentences:[""]),Ve(this.outputProperties,{extraTypes:[l.TriggerId,l.Results,l.DeviceId]})},oneditsave:function(){const e=[];$("#node-input-sentences-container").editableList("items").each((function(){const t=$(this).find("input").val();t&&e.push(t)})),this.sentences=e,this.outputProperties=Fe()}},Zn={category:Ge.HomeAssistantEntities,color:We.HaBlue,inputs:0,outputs:1,icon:"font-awesome/fa-toggle-on",align:"left",paletteLabel:"switch",label:function(){return this.name||"switch"},labelStyle:ze.labelStyle,defaults:{name:{value:""},version:{value:RED.settings.get("haSwitchVersion",0)},debugenabled:{value:!1},inputs:{value:0},outputs:{value:2},entityConfig:{value:"",type:s.EntityConfig,filter:e=>"switch"===e.entityType,required:!0},enableInput:{value:!1},outputOnStateChange:{value:!1},outputProperties:{value:[{property:"outputType",propertyType:"msg",value:"state change",valueType:"str"},{property:"payload",propertyType:"msg",value:"",valueType:"entityState"}],validate:qe}},oneditprepare:function(){ze.setup(this),A(this),ct(a.Switch),Ve(this.outputProperties,{extraTypes:["entityState"]}),$("#node-input-outputOnStateChange").on("change",(function(){$("#ha-custom-ouputs").toggle($(this).is(":checked"))}))},oneditsave:function(){this.outputProperties=Fe(),$("#node-input-inputs").val($("#node-input-enableInput").is(":checked")?1:0)}},Xn={category:Ge.HomeAssistant,color:We.HaBlue,outputs:1,icon:"font-awesome/fa-tag",paletteLabel:"tag",label:function(){return this.name||"tag"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haTagVersion",0)},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},tags:{value:[""],required:!0,validate:function(e){return!!e.length}},devices:{value:[]},outputProperties:{value:[{property:"payload",propertyType:"msg",value:"",valueType:"eventData"},{property:"topic",propertyType:"msg",value:"",valueType:"triggerId"}],validate:qe},exposeToHomeAssistant:{value:void 0},haConfig:{value:void 0}},oneditprepare:function(){ze.setup(this),A(this);const e=$("#tags"),n=$("#devices");let i=[];const o=this._;ct(a.Switch,"exposeAsEntityConfig");e.editableList({addButton:!0,removable:!0,height:"auto",header:$("<div>").append(o("ha-tag.label.tags")),addItem:function(e,n,a){const s=$("<div />").appendTo(e);$("<span />",{text:o("ha-tag.label.tag"),style:"padding-right: 74px;"}).appendTo(s),((e,n)=>{const a=$("<select>",{width:"70%"}).append($("<option>").attr({value:t,selected:n===t}).text(o("ha-tag.label.all_tags"))).appendTo(e);i.forEach((e=>{$("<option>").attr({value:e.id,selected:e.id===n}).text(e.name||e.id).appendTo(a)}))})(s,a)},buttons:[{id:"ha-tag-update-tag-list",label:o("ha-tag.label.update_tag_list"),icon:"fa fa-refresh",click:()=>{tt(r,"tags",{params:{update:!0}})}}]}),$("#ha-tag-update-tag-list").css("float","right").css("margin-right","unset");function s(e,t){const n=e.name||e.tag_id,i=t.name||t.tag_id;return n===i?0:n.localeCompare(i)}const r=n=>{i=n.sort(s);const a=new Set;e.editableList("items").each((function(){const e=$(this).find("select").val();a.add(e)}));const o=Array.from(a).filter((e=>e===t||i.find((t=>t.id===e))));e.editableList("empty"),e.editableList("addItems",o),$("#no-tags-found").toggle(0===i.length)};Xe(this,"#node-input-server"),Qe("tags",(t=>{i=t,e.editableList("addItems",this.tags),r(t)})),$("#update-tag-list").on("click",(()=>{tt(r,"tags",{params:{update:!0}})})),n.editableList({addButton:!0,removable:!0,height:"auto",header:$("<div>").append(o("ha-tag.label.devices")),addItem:function(e,t,n){const i=$("<div />").appendTo(e);$("<span />",{text:o("ha-tag.label.device_id"),style:"padding-right: 35px;"}).appendTo(i);const a=$.isEmptyObject(n)?"":n;$("<input />",{type:"text",class:"input-device"}).appendTo(i).val(a)}}),n.editableList("addItems",this.devices),Ve(this.outputProperties,{extraTypes:["eventData","tagId"]})},oneditsave:function(){const e=$("#tags").editableList("items"),t=$("#devices").editableList("items"),n=new Set,i=new Set;e.each((function(){const e=$(this).find("select").val();n.add(e)})),t.each((function(){const e=$(this).find(".input-device").val();e.trim().replace(/\s/g,"").length&&i.add(e)})),this.tags=Array.from(n),this.devices=Array.from(i),this.outputProperties=Fe()}},Yn={category:Ge.HomeAssistantEntities,color:We.Beta,inputs:0,outputs:1,icon:"font-awesome/fa-font",align:"left",paletteLabel:"text",label:function(){return this.name||"text"},labelStyle:ze.labelStyle,defaults:{name:{value:""},version:{value:RED.settings.get("haTextVersion",0)},debugenabled:{value:!1},inputs:{value:0},outputs:{value:1},entityConfig:{value:"",type:s.EntityConfig,filter:e=>"text"===e.entityType,required:!0},mode:{value:r.Listen},value:{value:"payload"},valueType:{value:l.Message},outputProperties:{value:[{property:"payload",propertyType:l.Message,value:"",valueType:l.Value},{property:"previousValue",propertyType:l.Message,value:"",valueType:l.PreviousValue}],validate:qe}},oneditprepare:function(){ze.setup(this),A(this),ct(a.Text),$("#dialog-form").prepend(ze.betaWarning(963));const e=$("#node-input-value").parent();$("#node-input-mode").on("change",(function(){e.toggle(this.value===r.Set),$("#node-input-inputs").val(this.value===r.Listen?0:1)})),$("#node-input-value").typedInput({types:[l.Message,l.Flow,l.Global,l.JSONata,l.String],typeField:"#node-input-valueType",type:this.valueType}),Ve(this.outputProperties,{extraTypes:[l.Value,l.PreviousValue]})},oneditsave:function(){this.outputProperties=Fe()}},Qn={category:Ge.HomeAssistant,color:We.HaBlue,outputs:1,icon:"font-awesome/fa-clock-o",paletteLabel:"time",label:function(){return this.name||(this.entityId?`${this.entityId}.${this.property||"state"}`:"time")},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haTimeVersion",0)},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},entityId:{value:"",required:!0},property:{value:""},offset:{value:"0"},offsetType:{value:"num"},offsetUnits:{value:"minutes"},randomOffset:{value:!1},repeatDaily:{value:!1},outputProperties:{value:[{property:"payload",propertyType:"msg",value:"",valueType:"entityState"},{property:"data",propertyType:"msg",value:"",valueType:"entity"},{property:"topic",propertyType:"msg",value:"",valueType:"triggerId"}],validate:qe},sunday:{value:!0},monday:{value:!0},tuesday:{value:!0},wednesday:{value:!0},thursday:{value:!0},friday:{value:!0},saturday:{value:!0},debugenabled:{value:void 0},exposeToHomeAssistant:{value:void 0},haConfig:{value:void 0},payload:{value:void 0},payloadType:{value:void 0}},oneditprepare:function(){ze.setup(this);const e=$("#node-input-server"),t=$("#node-input-entityId");Xe(this,"#node-input-server"),A(this),ct(a.Switch,"exposeAsEntityConfig"),Jt({root:"#node-input-entityId"}),$("#node-input-property").autocomplete({source:(n,i)=>{const a=function(e,t){if(!(e in m))return[];const n=t in m[e]?Object.keys(w(m[e][t])):Object.values(m[e]).map((e=>Object.keys(w(e))));return[...new Set([].concat(...n))].sort(((e,t)=>!e.includes(".")&&t.includes(".")?-1:e.includes(".")&&!t.includes(".")?1:e<t?-1:e>t?1:0))}(e.val(),t.val());i($.ui.autocomplete.filter(a,n.term))},minLength:0}),$("#node-input-offset").typedInput({types:["num","jsonata"],typeField:"#node-input-offsetType"}),$("#node-input-payload").typedInput({types:["str","num","bool","jsonata","date"],typeField:"#node-input-payloadType"}),$("#node-input-repeatDaily").on("change",(function(){$("#days-of-the-week").toggle($(this).is(":checked"))})).trigger("change"),Ve(this.outputProperties,{extraTypes:["entityState","entityId","entity"]})},oneditsave:function(){this.outputProperties=Fe()}},ei={category:Ge.HomeAssistantEntities,color:We.Beta,inputs:0,outputs:1,icon:"font-awesome/fa-clock-o",align:"left",paletteLabel:"time",label:function(){return this.name||"time entity"},labelStyle:ze.labelStyle,defaults:{name:{value:""},version:{value:RED.settings.get("haTimeEntityVersion",0)},debugenabled:{value:!1},inputs:{value:0},outputs:{value:1},entityConfig:{value:"",type:s.EntityConfig,filter:e=>"time"===e.entityType,required:!0},mode:{value:r.Listen},value:{value:"payload"},valueType:{value:l.Message},outputProperties:{value:[{property:"payload",propertyType:l.Message,value:"",valueType:l.Value},{property:"previousValue",propertyType:l.Message,value:"",valueType:l.PreviousValue}],validate:qe}},oneditprepare:function(){ze.setup(this),A(this),ct(a.Time),$("#dialog-form").prepend(ze.betaWarning(988));const e=$("#node-input-value").parent();$("#node-input-mode").on("change",(function(){e.toggle(this.value===r.Set),$("#node-input-inputs").val(this.value===r.Listen?0:1)})),$("#node-input-value").typedInput({types:[l.Message,l.Flow,l.Global,l.JSONata,l.String],typeField:"#node-input-valueType",type:this.valueType}),Ve(this.outputProperties,{extraTypes:[l.Value,l.PreviousValue]})},oneditsave:function(){this.outputProperties=Fe()}};var ti,ni,ii,ai;!function(e){e.ThisEntity="this_entity",e.EntityId="entity_id"}(ti||(ti={})),function(e){e.CurrentState="current_state",e.PreviousState="previous_state",e.Property="property"}(ni||(ni={})),function(e){e.Default="default",e.Custom="custom",e.Payload="payload"}(ii||(ii={})),function(e){e.Always="always",e.CurrentState="current_state",e.PreviousState="previous_state",e.Property="property"}(ai||(ai={}));const oi={category:Ge.HomeAssistant,color:We.HaBlue,inputs:0,outputs:2,outputLabels:function(e){if(0===e)return"allowed";if(1===e)return"blocked";const t=this.customOutputs[e-2];let n;return n=t.comparatorPropertyType===ai.Always?"always sent":`${t.comparatorPropertyType.replace("_"," ")} ${t.comparatorType.replace("_","")} ${t.comparatorValue}`,n},icon:"font-awesome/fa-map-signs",paletteLabel:"trigger: state",label:function(){return this.name||`trigger-state: ${this.entityId}`},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("triggerStateVersion",0)},inputs:{value:0},outputs:{value:2},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},entityId:{value:"",required:!0},entityIdType:{value:"exact"},debugEnabled:{value:!1},constraints:{value:[{targetType:ti.ThisEntity,targetValue:"",propertyType:ni.CurrentState,propertyValue:"new_state.state",comparatorType:n.Is,comparatorValueDatatype:l.String,comparatorValue:""}]},customOutputs:{value:[]},outputInitially:{value:!1},stateType:{value:$n.String},enableInput:{value:!1},exposeToHomeAssistant:{value:void 0},haConfig:{value:void 0},entityid:{value:void 0},entityidfiltertype:{value:void 0},debugenabled:{value:void 0},customoutputs:{value:void 0},outputinitially:{value:void 0},state_type:{value:void 0}},oneditprepare:function(){ze.setup(this);const e=$("#constraint-list"),t=$("#output-list");Xe(this,"#node-input-server",(e=>{n.serverChanged(e)})),ct(a.Switch,"exposeAsEntityConfig");const n=new Pn({filterTypeSelector:"#node-input-entityIdType",entityId:this.entityId,serverId:Ye()});$("#dialog-form").data("entitySelector",n);let i=[],o=[],s=[];Qe("entities",(e=>{i=e})),Qe("properties",(e=>{o=e,s=[...e.map((e=>`new_state.${e}`)),...e.map((e=>`old_state.${e}`))].sort()})),A(this);const r=$("#node-input-outputs").val('{"0": 0, "1": 1}'),u=()=>JSON.parse(r.val()),d=e=>{r.val(JSON.stringify(e))},c=e=>{t.editableList("items").each((function(t){const n=$(this).data("data");e[Object.prototype.hasOwnProperty.call(n,"index")?n.index:n._index]=t+2}))};e.on("change",".target-type",(function(){const e=$(this),t=e.val()===ti.ThisEntity,n=e.parent().parent(),i=e.next(),a=n.find(".property-type");t?i.attr("disabled","disabled").val(""):i.removeAttr("disabled"),a.find(`option[value=${ni.PreviousState}]`).toggle(t),a.val()===ni.PreviousState&&a.val(ni.CurrentState).trigger("change")})),e.on("change",".property-type",(function(e){const t=e.target.value;[ni.CurrentState,ni.PreviousState].includes(t)?$(this).next().attr("disabled","disabled").val(""):$(this).next().removeAttr("disabled")})),t.on("change",".comparator-property-type",(function(e){const t=e.target.value,n=$(this).parent().parent(),i=n.find(".comparator-type"),a=n.find(".comparator-value"),o=n.find(".comparator-property-value");switch(t){case"always":o.attr("disabled","disabled"),i.attr("disabled","disabled"),a.attr("disabled","disabled"),o.val("");break;case"previous_state":case"current_state":o.attr("disabled","disabled"),i.removeAttr("disabled"),a.removeAttr("disabled"),o.val("");break;case"property":o.removeAttr("disabled"),i.removeAttr("disabled"),a.removeAttr("disabled")}}));e.editableList({addButton:!0,removable:!0,height:"auto",header:$("<div>").append(p("trigger-state.label.conditions")),addItem:(e,t,n)=>{if($("#constraint-template").children().clone().appendTo(e),e.find(".target-value").autocomplete({source:(e,t)=>{const n=e.term.toLowerCase(),a=i.filter((e=>e.includes(n)));t(a)},minLength:0}),e.find(".property-value").autocomplete({source:(t,n)=>{const i=t.term.toLowerCase();n((e.find(".target-type").val()===ti.ThisEntity?s:o).filter((e=>e.includes(i))))},minLength:0}),e.find(".comparator-value").typedInput({default:"str",types:["str","num","bool","re","jsonata",{value:"entity",label:"entity."},{value:"prevEntity",label:"prev entity."}]}),$.isEmptyObject(n))return;e.find(".target-type").val(n.targetType).trigger("change"),e.find(".target-value").val(n.targetValue),e.find(".property-type").val(n.propertyType).trigger("change"),n.propertyType===ni.Property&&e.find(".property-value").val(n.propertyValue),e.find(".comparator-type").val(n.comparatorType);const a=e.find(".comparator-value");a.typedInput("type",n.comparatorValueDatatype),a.typedInput("value",n.comparatorValue)}}),e.editableList("addItems",this.constraints.length?this.constraints:[]),t.on("change",".message-type",(function(e){const t=e.target.value;$(this).parent().find(".message-value").typedInput("default"===t?"hide":"show")})),t.on("change",".comparator-property-type",(function(e){const t=e.target.value,n=$(this).parent().parent(),i=n.find(".comparator-property-value"),a=n.find(".comparator-type"),o=n.find(".comparator-value");switch(t){case ai.Always:i.attr("disabled","disabled"),a.attr("disabled","disabled"),o.typedInput("hide"),i.val("");break;case ai.PreviousState:case ai.CurrentState:i.attr("disabled","disabled"),a.removeAttr("disabled"),o.typedInput("show"),i.val("");break;case ai.Property:i.removeAttr("disabled"),a.removeAttr("disabled"),o.typedInput("show")}})),t.editableList({addButton:!0,removable:!0,sortable:!0,height:"auto",header:$("<div>").append("Custom outputs"),addItem:function(e,t,n){n.hasOwnProperty("condition")||(n.condition={});const i=n.condition;n.hasOwnProperty("index")||(n._index=Math.floor(563609*Math.random()).toString()),$("#output-template").children().clone().appendTo(e),e.css({overflow:"hidden",whiteSpace:"nowrap"}),e.find(".message-value").typedInput({default:l.JSON,types:[l.String,l.Number,l.Boolean,l.JSON,l.JSONata]}),e.find(".comparator-property-value").autocomplete({source:(e,t)=>{const n=e.term.toLowerCase();t(s.filter((e=>e.includes(n))))},minLength:0}),e.find(".comparator-value").typedInput({default:l.String,types:[l.String,l.Number,l.Boolean,l.Regex,l.JSONata,{value:"entity",label:"entity."},{value:"prevEntity",label:"prev entity."}]});const a=u();if(a[n.hasOwnProperty("index")?n.index:n._index]=t+2,d(a),$.isEmptyObject(i))return void e.find(".message-type,.comparator-property-type").trigger("change");e.find(".message-type").val(i.messageType).trigger("change");const o=e.find(".message-value");o.typedInput("value",i.messageValue),o.typedInput("type",i.messageValueType),e.find(".comparator-property-type").val(i.comparatorPropertyType).trigger("change"),"property"===i.comparatorPropertyType&&e.find(".comparator-property-value").val(i.comparatorPropertyValue),e.find(".comparator-type").val(i.comparatorType);const r=e.find(".comparator-value");r.typedInput("value",i.comparatorValue),r.typedInput("type",i.comparatorValueDataType)},removeItem:function(e){const t=u();Object.prototype.hasOwnProperty.call(e,"index")?t[e.index]=-1:delete t[e._index],c(t),d(t)},sortItems:function(){const e=u();c(e),d(e)}}),this.customOutputs.forEach(((e,n)=>t.editableList("addItem",{condition:e,index:n+2})))},oneditsave:function(){const e=$("#constraint-list").editableList("items"),t=$("#output-list").editableList("items"),n=[],i=[];e.each((function(){const e=$(this),t=e.find(".comparator-value"),i={targetType:e.find(".target-type").val(),targetValue:e.find(".target-value").val(),propertyType:e.find(".property-type").val(),propertyValue:e.find(".property-value").val(),comparatorType:e.find(".comparator-type").val(),comparatorValueDatatype:t.typedInput("type"),comparatorValue:t.typedInput("value")};i.propertyType===ni.CurrentState?i.propertyValue="new_state.state":i.propertyType===ni.PreviousState&&(i.propertyValue="old_state.state"),n.push(i)})),t.each((function(){const e=$(this),t=e.find(".message-value"),n=e.find(".comparator-value"),a={messageType:e.find(".message-type").val(),messageValue:t.typedInput("value"),messageValueType:t.typedInput("type"),comparatorPropertyType:e.find(".comparator-property-type").val(),comparatorPropertyValue:e.find(".comparator-property-value").val(),comparatorType:e.find(".comparator-type").val(),comparatorValue:n.typedInput("value"),comparatorValueDataType:n.typedInput("type")};a.comparatorPropertyType===ai.CurrentState?a.comparatorPropertyValue="new_state.state":a.comparatorPropertyType===ai.PreviousState&&(a.comparatorPropertyValue="old_state.state"),i.push(a)})),$("#node-input-inputs").val($("#node-input-enableInput").is(":checked")?1:0),this.constraints=n,this.customOutputs=i;const a=$("#dialog-form").data("entitySelector");this.entityId=a.entityId,a.destroy()},oneditcancel:function(){$("#dialog-form").data("entitySelector").destroy()}},si={category:Ge.HomeAssistantEntities,color:We.HaBlue,inputs:1,outputs:1,icon:"font-awesome/fa-asterisk",align:"right",paletteLabel:"update config",label:function(){return this.name||"update config"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},entityConfig:{value:"",type:s.EntityConfig,required:!1},version:{value:RED.settings.get("haSensorVersion",0)},outputProperties:{value:[],validate:qe}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),"_ADD_"===this.entityConfig&&$("#node-input-entityConfig").val("_ADD_"),Ve(this.outputProperties)},oneditsave:function(){this.outputProperties=Fe()}},ri={category:Ge.HomeAssistant,color:We.HaBlue,inputs:1,outputs:1,outputLabels:["","timed out"],icon:"ha-wait-until.svg",paletteLabel:"wait until",label:function(){return this.name||"wait until"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haWaitUntilVersion",0)},outputs:{value:1},entityId:{value:""},entityIdFilterType:{value:"exact"},property:{value:""},comparator:{value:"is"},value:{value:""},valueType:{value:"str"},timeout:{value:"0"},timeoutType:{value:"num"},timeoutUnits:{value:"seconds"},checkCurrentState:{value:!0},blockInputOverrides:{value:!0},outputProperties:{value:[]},entityLocation:{value:"data"},entityLocationType:{value:"none"}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server",(t=>{e.serverChanged(t)}));const e=new Pn({filterTypeSelector:"#node-input-entityIdFilterType",entityId:this.entityId,serverId:Ye()});$("#dialog-form").data("entitySelector",e);let t=[];Qe("properties",(e=>{t=e,$("#node-input-property").autocomplete({source:t,minLength:0})}));const i={value:"entity",label:"entity."},a=[l.String,l.Number,l.Boolean,l.Regex,l.JSONata,l.Message,l.Flow,l.Global,i];$("#node-input-value").typedInput({default:l.String,types:a,typeField:"#node-input-valueType"}),$("#node-input-comparator").on("change",(function(){let e=a;const t=$(this).val();switch($("#node-input-property").prop("disabled","jsonata"===t),t){case n.Is:case n.IsNot:break;case n.IsLessThan:case n.IsLessThanOrEqual:case n.IsGreaterThan:case n.IsGreaterThanOrEqual:e=[l.Number,l.JSONata,l.Message,l.Flow,l.Global,i];break;case n.Includes:case n.DoesNotInclude:e=[l.String,l.JSONata,l.Message,l.Flow,l.Global];break;case n.JSONata:e=[l.JSONata]}$("#node-input-value").typedInput("types",e)}));const s=this;$("#node-input-timeout").typedInput({default:l.Number,types:[l.Number,l.JSONata],typeField:"#node-input-timeoutType"}).on("change",(function(e,t){!0!==t&&(s.outputs=t===l.JSONata||t===l.Number&&Number($(this).val())>0?2:1)}));const r=$("#node-input-entityIdFilterType");r.on("change",(function(){$(".exact-only").toggle(r.val()===o.Exact)})),Ve(this.outputProperties,{extraTypes:["entity"]})},oneditsave:function(){this.outputProperties=Fe();const e=$("#dialog-form").data("entitySelector");this.entityId=e.entityId,e.destroy()},oneditcancel:function(){$("#dialog-form").data("entitySelector").destroy()}};function li(e){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";return Array.from({length:e},(()=>t[Math.floor(62*Math.random())])).join("")}function ui(){return["method_post","method_get","method_put","method_head"].some((e=>this[e]))}const pi={category:Ge.HomeAssistant,color:We.HaBlue,outputs:1,outputLabels:"",icon:"ha-webhook.svg",paletteLabel:"webhook",label:function(){return this.name||"webhook"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haWebhookVersion",0)},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},outputs:{value:1},webhookId:{value:li(32),required:!0},method_get:{value:!1,validate:ui},method_head:{value:!1,validate:ui},method_post:{value:!0,validate:ui},method_put:{value:!0,validate:ui},outputProperties:{value:[{property:"topic",propertyType:"msg",value:"",valueType:"triggerId"},{property:"payload",propertyType:"msg",value:"",valueType:"data"}],validate:qe},payloadLocation:{value:!1},payloadLocationType:{value:!1},headersLocation:{value:!1},headersLocationType:{value:!1}},oneditprepare:function(){ze.setup(this),Xe(this,"#node-input-server"),A(this);const e=$("#node-input-webhookId");ct(a.Switch,"exposeAsEntityConfig"),$("#copyId").on("click",(function(){const t=e.get(0),n=t.value;t.value=`https://<ip>:<port>/api/webhook/${n}`,t.select(),t.setSelectionRange(0,99999),document.execCommand("copy"),t.value=n})),$("#refresh").on("click",(function(){e.val(li(32))})),$("[id^=node-input-method_]").on("change",(function(){$("[id^=node-input-method_]").is(":checked")?$(this).closest("div").removeClass("input-error"):$(this).closest("div").addClass("input-error")})).trigger("change"),Ve(this.outputProperties,{extraTypes:["receivedData","headers","params","triggerId"]})},oneditsave:function(){this.outputProperties=Fe()}},di={category:Ge.HomeAssistant,color:We.HaBlue,outputs:1,icon:"font-awesome/fa-map-marker",paletteLabel:"zone",label:function(){return this.name||"zone"},labelStyle:ze.labelStyle,defaults:{name:{value:""},server:{value:"",type:s.Server,required:!0},version:{value:RED.settings.get("haZoneVersion",0)},exposeAsEntityConfig:{value:"",type:s.EntityConfig,filter:e=>e.entityType===a.Switch,required:!1},entities:{value:[""],required:!0,validate:e=>!!e.length},event:{value:"enter"},zones:{value:[""],required:!0,validate:e=>!!e.length},exposeToHomeAssistant:{value:void 0},haConfig:{value:void 0}},oneditprepare:function(){ze.setup(this);const e=$("#entities"),t=$("#zones");Xe(this,"#node-input-server"),A(this),ct(a.Switch,"exposeAsEntityConfig"),e.editableList({addButton:!0,removable:!0,height:"auto",header:$("<div>").append("Entities"),addItem:function(e,t,n){const i=$("<div />").appendTo(e);$("<span />",{text:"Entity",style:"padding-right: 35px;"}).appendTo(i);const a=$.isEmptyObject(n)?"":n;Jt({root:$("<input />",{type:"text",class:"input-entity"}).appendTo(i).val(a),options:{type:"trackers"}})}}),e.editableList("addItems",this.entities),t.editableList({addButton:!0,removable:!0,height:"auto",header:$("<div>").append("zones"),addItem:function(e,t,n){const i=$("<div />").appendTo(e);$("<span />",{text:"Zone",style:"padding-right: 35px;"}).appendTo(i);const a=$.isEmptyObject(n)?"":n;Jt({root:$("<input />",{type:"text",class:"input-zone"}).appendTo(i).val(a),options:{type:"zones"}})}}),t.editableList("addItems",this.zones)},oneditsave:function(){const e=$("#entities").editableList("items"),t=$("#zones").editableList("items"),n=new Set,i=new Set;e.each((function(){const e=$(this).find(".input-entity").val().replace(/\s/g,"");e.length&&n.add(e)})),t.each((function(){const e=$(this).find(".input-zone").val().replace(/\s/g,"");e.length&&i.add(e)})),this.entities=Array.from(n),this.zones=Array.from(i)}};RED.comms.subscribe("homeassistant/areas/#",(function(e,t){const n=T(e);g[n]=t})),RED.comms.subscribe("homeassistant/devices/#",(function(e,t){const n=T(e);h[n]=t})),RED.comms.subscribe("homeassistant/entity/#",(function(e,t){const n=T(e);m[n]||(m[n]={}),m[n][t.entity_id]=t})),RED.comms.subscribe("homeassistant/entities/#",(function(e,t){const n=T(e);m[n]=t})),RED.comms.subscribe("homeassistant/integration/#",(function(e,t){const n=e.split("/")[2];C[n]=t.version})),RED.comms.subscribe("homeassistant/services/#",(function(e,t){const n=T(e);f[n]=t})),RED.comms.subscribe("homeassistant/targetDomains/#",(function(e,t){const n=T(e);b[n]=t})),RED.comms.subscribe("home-assistant-print-to-debug",(function(e,t){RED.debug.handleDebugMessage(t)})),function(){const e="home-assistant.ui.migrations",t=p(`${e}.title`),n=p(`${e}.warning`),i=p(`${e}.message`),a=p(`${e}.button_label`),o=p("home-assistant.ui.notifications.attention"),s=$.parseHTML(`<div id="ha-dialog-confirm" title="${t}">\n            ${i}\n            <div class="ui-state-error ha-alert-box"><strong>${o}:</strong> ${n}</div>\n        </div>`),r=$.parseHTML(`<li><button id="upgrade-ha-node"><i class="fa fa-refresh"></i> ${a}</button></li>`);$("body").append(s),$("#red-ui-header .red-ui-header-toolbar").prepend(r)}(),Ie=$("#upgrade-ha-node"),Ie.hide(),Ie.on("click",Ce),RED.editor.registerTypeEditor("ha_entity_filter",x),RED.events.on("nodes:add",(function(e){ke(e)&&!je(e)&&Ie.show()})),RED.events.on("nodes:remove",(function(e){Ie.is(":visible")&&ke(e)&&0===Re()&&Ie.hide()})),RED.events.on("editor:open",(function(){var e;const t=RED.view.selection(),n=null===(e=null==t?void 0:t.nodes)||void 0===e?void 0:e[0];n&&ke(n)&&!je(n)&&(Oe(n),RED.nodes.dirty(!0),RED.notify(p("home-assistant.ui.migrations.node_schema_updated")))})),RED.events.on("runtime-state",(function e(){RED.events.off("runtime-state",e);const t=$($('script[data-template-name="ha_sidebar"]').i18n().html()),n=$($('script[data-template-name="ha_sidebar_toolbar"]').i18n().html());!function(e){const t=$("<div>",{id:"home-assistant-stack",class:"home-assistant-sidebar-stack"}).appendTo(e),n=RED.stack.create({container:t});M=n.add({title:p("home-assistant.sidebar.stacks.server"),collapsible:!0}),F=n.add({title:p("home-assistant.sidebar.stacks.entity"),collapsible:!0}),q=n.add({title:p("home-assistant.sidebar.stacks.device"),collapsible:!0}),G()}(t),RED.sidebar.addTab({id:"ha_sidebar",label:"Home Assistant",name:"Home Assistant",content:t.get(0),closeable:!0,disableOnEdit:!0,iconClass:"fa fa-home",toolbar:n,onchange:()=>G()}),$("#home-assistant-diagnostics-button").on("click",(function(e){e.preventDefault();const t=p("home-assistant.sidebar.diagnostics.fetching_data"),n=$(`\n            <div id="home-assistant-diagnostics-dialog">\n                <textarea id="home-assistant-diagnostics-textarea" style="width: 100%;resize: none;" rows="12" >${t}</textarea>\n            </div>\n        `);RED.keyboard.disable(),n.dialog({classes:{"ui-dialog":"red-ui-editor-dialog","ui-dialog-titlebar-close":"hide","ui-widget-overlay":"red-ui-editor-dialog"},modal:!0,closeOnEscape:!0,width:450,resizable:!1,draggable:!1,title:p("home-assistant.sidebar.diagnostics.environment_data"),close:function(){$("#home-assistant-diagnostics-dialog").dialog("destroy").remove(),RED.keyboard.enable()},buttons:[{text:p("home-assistant.sidebar.diagnostics.copy"),click:function(){const e=document.getElementById("home-assistant-diagnostics-textarea");N(e.value),RED.notify(p("home-assistant.sidebar.diagnostics.copied")),$(this).dialog("close")}},{text:p("home-assistant.sidebar.diagnostics.close"),click:function(){$(this).dialog("close")}}]}),$.get("homeassistant/diagnostics",(function(e){$("#home-assistant-diagnostics-textarea").val(e)})).fail((function(){$("#home-assistant-diagnostics-textarea").val(p("home-assistant.sidebar.diagnostics.failed_fetch"))}))}))})),RED.nodes.registerType(s.DeviceConfig,ln),RED.nodes.registerType(s.EntityConfig,fn),RED.nodes.registerType(s.Server,zt),RED.nodes.registerType(s.API,lt),RED.nodes.registerType(s.CallSevice,Mt),RED.nodes.registerType(s.CurrentState,Zt),RED.nodes.registerType(s.Device,rn),RED.nodes.registerType(s.Entity,un),RED.nodes.registerType(s.EventsAll,bn),RED.nodes.registerType(s.EventsCalendar,Tn),RED.nodes.registerType(s.EventsState,Rn),RED.nodes.registerType(s.FireEvent,An),RED.nodes.registerType(s.GetEntities,Bn),RED.nodes.registerType(s.GetHistory,Vn),RED.nodes.registerType(s.PollState,Fn),RED.nodes.registerType(s.RenderTemplate,Gn),RED.nodes.registerType(s.Sentence,Kn),RED.nodes.registerType(s.Tag,Xn),RED.nodes.registerType(s.Time,Qn),RED.nodes.registerType(s.TriggerState,oi),RED.nodes.registerType(s.WaitUntil,ri),RED.nodes.registerType(s.Webhook,pi),RED.nodes.registerType(s.Zone,di),RED.nodes.registerType(s.BinarySensor,gt),RED.nodes.registerType(s.Button,ht),RED.nodes.registerType(s.Number,Mn),RED.nodes.registerType(s.Select,Wn),RED.nodes.registerType(s.Sensor,Jn),RED.nodes.registerType(s.Switch,Zn),RED.nodes.registerType(s.Text,Yn),RED.nodes.registerType(s.TimeEntity,ei),RED.nodes.registerType(s.UpdateConfig,si)}();</script>
...
<script type="text/html" data-help-name="ha-number"><div class="home-assistant-custom-block warning"><p class="custom-block-title">WARNING</p><p><em>Needs <a href="https://github.com/zachowj/hass-node-red">Custom Integration</a> installed in Home Assistant for this node to function</em></p></div><p>Creates a number in Home Assistant which can be manipulated from this node.</p><h3>Configuration</h3><dl class="message-properties"><dt>Mode <span text="required" class="home-assistant-badge">required</span><span class="property-type"></span></dt><dd>The mode of the node</dd><dt>Value <span text="required" class="home-assistant-badge">required</span><span class="property-type">number</span></dt><dd>The value of the entity should be updated to</dd></dl><h3>Inputs</h3><dl class="message-properties"><dd>properties of <code>msg.payload</code></dd><dt>value<span class="property-type">number</span></dt><dd>The value of the entity should be updated to</dd></dl><h3>Outputs</h3><dl class="message-properties"><dd>Value types:</dd><ul><li><code>value</code>: The value of the entity</li><li><code>previous value</code>: The previous value of the entity</li><li><code>config</code>: The config properties of the node</li></ul></dl><h3>Examples</h3><dl class="message-properties"><div><p><a href="https://zachowj.github.io/node-red-contrib-home-assistant-websocket/node/number.html#examples">link</a></p></div></dl></script>
...
<script type="text/html" data-help-name="ha-sentence"><p>A sentence trigger fires when <a href="https://www.home-assistant.io/voice_control/">Assist</a> matches a sentence from a voice assistant using the default <a href="https://www.home-assistant.io/integrations/conversation/">conversation agent</a>.</p><p>Sentences are allowed to use some basic template syntax. Check Home Assistant <a href="https://www.home-assistant.io/docs/automation/trigger/#sentence-trigger">documentation</a> for more information.</p><div class="home-assistant-custom-block warning"><p class="custom-block-title">WARNING</p><p><em>Needs <a href="https://github.com/zachowj/hass-node-red">Custom Integration</a> installed in Home Assistant for this node to function</em></p></div><h3>Configuration</h3><dl class="message-properties"><dt>Sentences<span class="property-type">string</span></dt><dd>A list of sentences to match. Sentences are allowed to use some basic template syntax. Check Home Assistant <a href="https://www.home-assistant.io/docs/automation/trigger/#sentence-trigger">documentation</a> for more information.</dd><dt>Expose as<span class="property-type">string</span></dt><dd>When an entity is selected a switch entity will be created in Home Assistant. Turning on and off this switch will disable/enable the nodes in Node-RED.</dd></dl><h3>Outputs</h3><dl class="message-properties"><dd>Value types:</dd><ul><li><code>trigger id</code>: sentence that triggered the flow</li><li><code>config</code>: config properties of the node</li></ul></dl><h3>Examples</h3><dl class="message-properties"><div><p><a href="https://zachowj.github.io/node-red-contrib-home-assistant-websocket/node/sentence.html#examples">link</a></p></div></dl></script>
...
<script type="text/html" data-template-name="ha-sentence"><input type="hidden" id="node-input-version"><div class="form-row"><label for="node-input-name" data-i18n="ha-sentence.label.name"></label> <input type="text" id="node-input-name"></div><div class="form-row"><label for="node-input-server" data-i18n="ha-sentence.label.server"></label> <input type="text" id="node-input-server"></div><div class="form-row"><ol id="node-input-sentences-container"></ol></div><div class="form-row"><label for="node-input-response" data-i18n="ha-sentence.label.response"></label> <input type="text" id="node-input-response" placeholder="Done"></div><div class="form-row"><ol id="custom-outputs"></ol></div><div class="form-row" id="exposed-as-row"><label for="node-input-exposeAsEntityConfig" data-i18n="ha-tag.label.expose_as"></label> <input type="text" id="node-input-exposeAsEntityConfig"></div></script>
