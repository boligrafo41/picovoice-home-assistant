...
PICOVOICE_ACCESS_KEY= os.getenv("05nuxDRAVjboy6biLTuc/Sy+aHgxCEp00ZM7kDjnibTrXD0QVCbLhw==")

# Configuracón de los ficheros Porcupine y Rhino
PORCUPINE_MODEL_FILE_PATH = "/docker/picovoice/config/Beltran_es_raspberry-pi_v3_0_0.ppn"
RHINO_MODEL_FILE_PATH = "/docker/picovoice/config/Domotica_es_raspberry-pi_v3_0_0.rhn"
